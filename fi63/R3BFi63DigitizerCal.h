...
// R3BFi63DigitizerCal.h

#ifndef R3BFI63DIGITIZERCAL_H
#define R3BFI63DIGITIZERCAL_H 1
...
class R3BFi63DigitizerCal : public FairTask
{
  ...
  public:
    ...
    R3BFi63DigitizerCal(const char* name, Int_t iVerbose = 1);
   
    /** Destructor **/
   virtual  ~R3BFi63DigitizerCal();
  ...
  protected:
    ...
    TClonesArray* fFi63Cals;
    TClonesArray* fFi63TriggerCals;
  ...
  Float_t  detector_width = fiber_nbr*fiber_thickness*(1+air_layer);  
    ...
    ClassDef(R3BFi63DigitizerCal, 1);
};
