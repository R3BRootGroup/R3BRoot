...
ClassImp(R3BFi63ContFact)

    static R3BFi63ContFact gR3BFi63ContFact;

R3BFi63ContFact::R3BFi63ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi63ContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi63ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi63GeoPar", "Fi63 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi63ContFact::createContainer(FairContainer* c)
{
...
void R3BFi63ContFact::activateParIo(FairParIo* io)
{
