...
void R3BActar::Initialize()
{
    ...
    LOG(INFO) << "R3BActar: initialisation" << FairLogger::endl;
    LOG(DEBUG) << "R3BActar: Vol. (McId) " << gMC->VolId("PSP1Log") << FairLogger::endl;
}
...
void R3BActar::Print(Option_t* option) const
{
    ...
    LOG(INFO) << "R3BActar: " << nHits << " points registered in this event" << FairLogger::endl;
}
// ----------------------------------------------------------------------------
...
void R3BActar::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    LOG(INFO) << "R3BActar: " << nEntries << " entries to add" << FairLogger::endl;
    ...
    LOG(INFO) << "R3BActar: " << cl2->GetEntriesFast() << " merged entries" << FairLogger::endl;
}
