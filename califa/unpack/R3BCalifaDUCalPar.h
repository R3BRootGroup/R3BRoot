...
class R3BCalifaDUCalPar : public FairDbObjTableMap
{
  ...
  public:
    ...
    virtual FairDbObjTableMap* CreateObjTableMap() const { return new R3BCalifaDUCalPar(); }
    ...
    {
        return ValCondition(FairDbDetector::kCal, DataType::kData, ValTimeStamp((Double_t)rid));
    }
  ...
  private:
    ...
    Double_t fQuenchingFactor; // quenching factor for protons (tentative) calculated from proton and pulser
                               // measurements
    Double_t fPidGain;
