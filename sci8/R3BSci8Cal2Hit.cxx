...
{	
	...
	if(fhQ1_vs_Q2) delete(fhQ1_vs_Q2) ;	
...
InitStatus R3BSci8Cal2Hit::ReInit()
{
    return kSUCCESS;
}
 ...
 */ 
	    ...
	    {     
            ...
            if(time_L[iPart][ipm] > 0. && !(IS_NAN(time_L[iPart][ipm]))) timeT[iPart] += time_L[iPart][ipm];
             
            if(time_V[iPart][ipm] > 0. && !(IS_NAN(time_V[iPart][ipm]))) timeM[iPart] += time_V[iPart][ipm];
...
void R3BSci8Cal2Hit::FinishTask()
{
	...
	if(fhQ1_vs_Q2) fhQ1_vs_Q2->Write() ;	
