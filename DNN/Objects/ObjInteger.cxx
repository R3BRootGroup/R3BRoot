...
ObjInteger::ObjInteger(TString const Key) 
{
    TheNumber = 0;
    ThisName = Key;
}
...
// Content constructor:
ObjInteger::ObjInteger(TString const Key, Int_t const num) 
{
    ThisName = Key;
    TheNumber = num;
}
...
// Set-functions:
void ObjInteger::SetNumber(Int_t const num) {TheNumber = num;}
void ObjInteger::SetTheName(TString const Key) {ThisName = Key;}
    
// Get-functions:
Int_t ObjInteger::GetNumber() {return TheNumber;}
TString ObjInteger::GetTheName() {return ThisName;}
    
// Printing function:
void ObjInteger::Print()
{
    cout << "ObjInteger " << ThisName << " = " << TheNumber << "\n";
}

// Writing function:
void ObjInteger::WriteToFile(TFile* TheFile)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if ((opt=="UPDATE")||(opt=="CREATE"))
            {
                ...
                TheFile->cd();
                ObjInteger* temp = new ObjInteger(ThisName,TheNumber);
...
// Reading function:
void ObjInteger::ReadFromFile(TFile* TheFile)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if ((opt=="UPDATE")||(opt=="READ"))
            {
                ...
                TheFile->cd();
                ObjInteger* temp = (ObjInteger*) TheFile->Get(ThisName);
