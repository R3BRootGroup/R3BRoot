...
#ifndef R3BHANDSHAKECLUSTERFINDER_LEAK_H
#define R3BHANDSHAKECLUSTERFINDER_LEAK_H
...
#include "R3BSignal.h"
#include "R3BSignalCluster_Vect.h"
#include "R3BInputClass.h"
#include "Nuclei.h"

// Class definition:
class R3BHandShakeClusterFinder_Leak : public FairTask
{
    public:
        // Default constructor:
        R3BHandShakeClusterFinder_Leak();

        // Destructor:
        virtual ~R3BHandShakeClusterFinder_Leak();
    ...
    private:
        ...
        TCAOutputConnector<R3BSignalCluster_Vect> fClusters;              // Outputs: the clusters.
        Double_t TimeRadius;
    ...
    public:
        ...
        ClassDef(R3BHandShakeClusterFinder_Leak, 1);
};
