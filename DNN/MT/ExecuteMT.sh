...
# This script performs a MultiThread simulation
# over parallel part of the process. It has only 
# one input argument: the number of threads:
...
then
    ...
    then
        ...
        do
            ...
            ./ExecuteOneThread.sh $1 ${CurrentThread} &
