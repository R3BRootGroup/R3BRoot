void R3BInputClass::CreateElenaFile(TString const Name)
{
    // Creates a new InputFile with parameters that match
    // Elena Hoemanns master thesis.
    ...
    else
    {
        ...
        // Cave:
        ++NLines; AddInputBoolian("R3BRoot_Cave_IsVacuum",kTRUE);
        ...
        ++NLines; AddInputBoolian("ParticleGun_Uniformize_Detected_Multiplicity",kTRUE);
        ++NLines;  AddInputString("ParticleGun_MultDistribution","AdaptedElena");
        ++NLines;  AddInputDouble("ParticleGun_SingleDetectionRate","dimless",0.930);  
        ...
        ++NLines; AddInputBoolian("ParticleGun_RandomRotateNeutrons_SnDataFiles",kFALSE);
        ...
        ++NLines;  AddInputString("NeuLAND_Translator_MarkPrimSignals","JanMayer"); 
        ++NLines;  AddInputString("NeuLAND_Translator_ObtainPrimPoints","JanPrimPoints");
        ...
        ++NLines;  AddInputString("NeuLAND_DNNTextFile_InfoStructure","IO_Signals_ElenaHoemann");
        ...
        ++NLines; AddInputInteger("NeuLAND_DNNTextFile_EventBatchSize",500);
        ++NLines; AddInputInteger("NeuLAND_DNNTextFile_nEpochs",5);
        ...
        ++NLines;  AddInputString("NeuLAND_DNNTextFile_PreselectionMethod","Elena");
        ++NLines; AddInputBoolian("NeuLAND_DNNTextFile_ForceBatchesEqualLength",kTRUE);
        ++NLines;  AddInputString("NeuLAND_DNNTextFile_NormalizationMethod","Elena");
        ++NLines; AddInputBoolian("NeuLAND_DNNTextFile_MarkusFormat_AddRestNeutronsToOutput",kFALSE);
        ++NLines; AddInputBoolian("NeuLAND_DNNTextFile_UseTextFileBias",kFALSE);
        ++NLines; AddInputBoolian("NeuLAND_DNNTextFile_BiasSingleClusterEvents",kFALSE);
        ++NLines;  AddInputString("NeuLAND_DNNTextFile_TimeNormaliation_Method","Default");
