void R3BInputClass::CreateSAMURAIFile(TString const Name)
{
    ...
    else
    {
        ...
        ++NLines;  AddInputDouble("ParticleGun_MinimalKineticEnergy","MeV/u",249.0);
        ++NLines;  AddInputDouble("ParticleGun_MaximalKineticEnergy","MeV/u",253.0);
        ...
        ++NLines; AddInputBoolian("ParticleGun_IncludeSnNucleus_SnDataFiles",kFALSE);
        ...
        ++NLines;  AddInputString("ParticleGun_ExGenerator_TargetIsotope","Li7");
        ++NLines;  AddInputDouble("ParticleGun_ExGenerator_BeamEnergy","MeV/u",252.7);
        ...
        ++NLines;  AddInputDouble("NeuLAND_AluminiumFrame_Width","cm",-1.0);
        ++NLines;  AddInputDouble("NeuLAND_AluminiumFrame_Thickness","cm",-1.0);
        ++NLines; AddInputInteger("NeuLAND_Number_of_Bars_per_plane",50);
        ++NLines; AddInputInteger("NeuLAND_Number_of_DoublePlanes",4);
        ++NLines;  AddInputDouble("NeuLAND_center_x_position","cm",0.0);
        ++NLines;  AddInputDouble("NeuLAND_center_y_position","cm",0.0);
        ++NLines;  AddInputDouble("NeuLAND_front_z_position","cm",1093.5);
        ...
        // VETO:
        ++NLines; AddInputBoolian("VETO_Include_in_SETUP",kTRUE);
        ...
        ++NLines;  AddInputDouble("VETO_front_z_position","cm",1061.5);
        ...
        // NEBULA:
        ++NLines; AddInputBoolian("NEBULA_Include_in_SETUP",kTRUE);
        ...
        ++NLines;  AddInputDouble("NEBULA_front_z_position","cm",1500.0); 
        ...
        // NEBULA VETO:
        ++NLines; AddInputBoolian("NEBULA_VET_Include_in_SETUP",kTRUE);
        ...
        ++NLines;  AddInputDouble("NEBULA_VET_front_z_position","cm",1470.0);
        ...
        // SAMURAI Setup:
        ++NLines; AddInputBoolian("SAMURAI_SETUP_IncludeSetup",kTRUE);
        ...
        ++NLines;  AddInputDouble("NeuLAND_DNNTextFile_TimeNormaliation_RightBoundary","ns",66.0);
        ...
        ++NLines;  AddInputDouble("BetaReconstruction_Beta_LowerCut","dimless",0.605);
        ++NLines;  AddInputDouble("BetaReconstruction_Beta_UpperCut","dimless",0.625);
        ...
        ++NLines;  AddInputDouble("NeuLAND_Lower_EdepCut_Ex_Spectra","MeV",0.0);
    }
