...
void GLAD_BuildGeometry()
{
    ...
    geoFileName = geoFileName + ".geo.root";
    // --------------------------------------------------------------------------
    ...
    TString TheFileName = Inputs->GetInputString("TheOutputPath") + Inputs->GetInputString("GLAD_Geometry_FileName");
    TFile* geoFile = new TFile(TheFileName, "RECREATE");
    top->Write();
    geoFile->Close();
    // --------------------------------------------------------------------------
