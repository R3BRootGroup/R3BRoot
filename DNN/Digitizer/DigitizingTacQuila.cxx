...
#include <iostream>
    ...
    DigitizingTacQuila::Params::Params()
    {
        ...
        fRnd = new TRandom3(time(nullptr));
    ...
    {
        if (par.PrintParameters==kTRUE)
        {
            std::cout << "\n-------------------------------------------------------------------------\n";
            std::cout << "Digitizer Working Parameters: fPaddleHalfLength = " << par.fPaddleHalfLength << "\n";
            std::cout << "Digitizer Working Parameters: fPMTThresh = " << par.fPMTThresh << "\n";
            std::cout << "Digitizer Working Parameters: fSaturationCoefficient = " << par.fSaturationCoefficient << "\n";
            std::cout << "Digitizer Working Parameters: fTimeRes = " << par.fTimeRes << "\n";
            std::cout << "Digitizer Working Parameters: fEResRel = " << par.fEResRel << "\n";
            std::cout << "Digitizer Working Parameters: fIntegrationTime = " << par.fIntegrationTime << "\n";
            std::cout << "Digitizer Working Parameters: fcMedium = " << par.fcMedium << "\n";
            std::cout << "Digitizer Working Parameters: fAttenuation = " << par.fAttenuation << "\n";
            std::cout << "Digitizer Working Parameters: fLambda = " << par.fLambda << "\n";
            std::cout << "-------------------------------------------------------------------------\n\n";
        }
