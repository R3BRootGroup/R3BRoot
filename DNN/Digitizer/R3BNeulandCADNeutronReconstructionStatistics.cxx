#include "R3BNeulandCADNeutronReconstructionStatistics.h"
...
R3BNeulandCADNeutronReconstructionStatistics::R3BNeulandCADNeutronReconstructionStatistics(const TString primary,
...
InitStatus R3BNeulandCADNeutronReconstructionStatistics::Init()
{
    try
    {
    ...
    {
        LOG(FATAL) << "R3BNeulandCADNeutronReconstruction" << e.what() << FairLogger::endl;
    }
...
void R3BNeulandCADNeutronReconstructionStatistics::Exec(Option_t*)
{
    ...
    auto comp = [](const R3BNeulandCADNeutron* n, const R3BNeulandCADCluster* c) {
...
void R3BNeulandCADNeutronReconstructionStatistics::Finish()
{
