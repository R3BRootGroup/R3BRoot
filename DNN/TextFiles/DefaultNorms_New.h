void NormalizationClass::DefaultNorms(Double_t const NewLeft, Double_t const NewRight)
{
    ...
    NormUnit T_Norm;
    T_Norm.Name = "T";
    T_Norm.Normalization_Option = "LowerCutoff_UpperReset";
    ...
    Double_t Realistic_TimeInterval = (8.0 + 1.3*((Int_t) Inputs->GetInputInteger("NeuLAND_Number_of_DoublePlanes")))*TotalBarThickNess/(ceff*BeamBeta);
    ...
    TotalEnergyNorm.Old_MeanShift = 0.5*((((Int_t) Inputs->GetInputInteger("ParticleGun_Multiplicity"))+2.5)/7.5);
    TotalEnergyNorm.Old_MeanShift = TotalEnergyNorm.Old_MeanShift*(510.0*(1.0 - ((Int_t) Inputs->GetInputInteger("NeuLAND_Number_of_DoublePlanes")/30.0))+1.15*(1.0 + 2.56*((Int_t) Inputs->GetInputInteger("NeuLAND_Number_of_DoublePlanes")/30.0))*Inputs->GetAvgBeamEnergyPerNucleon());
    TotalEnergyNorm.Old_ScaleFactor = TotalEnergyNorm.Old_MeanShift;
    ...
    nClustersNorm.Old_MeanShift = 0.5*((((Int_t) Inputs->GetInputInteger("ParticleGun_Multiplicity"))+2.0)/7.0);
    nClustersNorm.Old_MeanShift = nClustersNorm.Old_MeanShift*(1.0*(17.0 - 3.0*((Int_t) Inputs->GetInputInteger("NeuLAND_Number_of_DoublePlanes")/30.0))+0.01*(1.0 + 6.5*((Int_t) Inputs->GetInputInteger("NeuLAND_Number_of_DoublePlanes")/30.0))*Inputs->GetAvgBeamEnergyPerNucleon());
    nClustersNorm.Old_ScaleFactor = nClustersNorm.Old_MeanShift;
