...
#ifndef R3BFI62DIGITIZER_H
#define R3BFI62DIGITIZER_H 1
...
class R3BFi62Digitizer : public FairTask
{
  ...
  public:
    ...
    R3BFi62Digitizer(Double_t esigma, Double_t tsigma, Double_t ysigma);
