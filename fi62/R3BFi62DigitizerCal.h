...
// R3BFi62DigitizerCal.h

#ifndef R3BFI62DIGITIZERCAL_H
#define R3BFI62DIGITIZERCAL_H 1
...
class R3BFi62DigitizerCal : public FairTask
{
  ...
  public:
    ...
    R3BFi62DigitizerCal(const char* name, Int_t iVerbose = 1);
   
    /** Destructor **/
   virtual  ~R3BFi62DigitizerCal();
  ...
  protected:
    ...
    TClonesArray* fFi62Cals;
    TClonesArray* fFi62TriggerCals;
  ...
  Float_t  detector_width = fiber_nbr*fiber_thickness*(1+air_layer);  
    ...
    ClassDef(R3BFi62DigitizerCal, 1);
};
