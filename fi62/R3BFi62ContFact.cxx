...
ClassImp(R3BFi62ContFact)

    static R3BFi62ContFact gR3BFi62ContFact;

R3BFi62ContFact::R3BFi62ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi62ContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi62ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi62GeoPar", "Fi62 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi62ContFact::createContainer(FairContainer* c)
{
...
void R3BFi62ContFact::activateParIo(FairParIo* io)
{
