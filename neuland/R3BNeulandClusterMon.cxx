...
InitStatus R3BNeulandClusterMon::Init()
{
    ...
    fhClusterEToFVSTime =
        new TH2D("ClusterEToFVSTime", "Cluster E_{ToF} vs. Cluster Time", 100, 0, 1000, 500, 0, 500);
    fhClusterEToFVSTime->GetXaxis()->SetTitle("Cluster E_{ToF} [MeV]");
    fhClusterEToFVSTime->GetYaxis()->SetTitle("Cluster t [ns]");

    fhClusterEVSTime =
            new TH2D("ClusterEVSTime", "Cluster E vs. Cluster Time", 250, 0, 250, 500, 0, 250);
...
void R3BNeulandClusterMon::Finish()
{
    ...
    gDirectory->mkdir("NeulandClusterMon");
    gDirectory->cd("NeulandClusterMon");
