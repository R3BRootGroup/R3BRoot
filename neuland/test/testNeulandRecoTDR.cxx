...
namespace
{
    ...
    class testRecoTDR : public testing::Test
    {
      protected:
        void SetUp() override
        {
            fClusters.push_back(new R3BNeulandCluster(R3BNeulandHit{
                874, 74.0923, 75.5003, 65.1535, 2.44689, 1.85643, 2.13131, { -7.5, 9.85647, 1487.5 }, {} }));
            fClusters.push_back(new R3BNeulandCluster({
                R3BNeulandHit{
                    425, 71.403, 69.528, 60.8227, 32.1342, 35.0932, 33.5811, { -13.1249, -2.5, 1442.5 }, {} },
                R3BNeulandHit{
                    426, 70.7576, 69.5846, 60.5282, 43.3598, 46.4116, 44.8598, { -8.21099, 2.5, 1442.5 }, {} },
                R3BNeulandHit{
                    475, 69.8556, 71.4452, 61.0075, 14.7869, 11.5298, 13.0572, { -2.5, 11.1271, 1447.5 }, {} },
                R3BNeulandHit{
                    428, 70.7084, 69.9433, 60.683, 17.4303, 19.8725, 18.6114, { -5.3562, 12.5, 1442.5 }, {} },
            }));
            fClusters.push_back(new R3BNeulandCluster(R3BNeulandHit{
                523, 70.0093, 72.2564, 61.49, 65.1076, 50.0853, 57.1045, { 15.7294, -12.5, 1452.5 }, {} }));
            fClusters.push_back(new R3BNeulandCluster(R3BNeulandHit{
                829, 71.509, 73.4678, 62.8456, 5.41213, 4.57457, 4.97576, { 13.7115, 17.5, 1482.5 }, {} }));
            fClusters.push_back(new R3BNeulandCluster({
                R3BNeulandHit{
                    925, 73.6385, 71.8902, 63.1215, 1.43794, 1.76745, 1.59421, { -12.2376, -2.5, 1492.5 }, {} },
                R3BNeulandHit{
                    974, 72.915, 72.227, 62.9281, 11.6925, 13.4288, 12.5306, { -7.5, -4.81552, 1497.5 }, {} },
                R3BNeulandHit{
            ...
            fClusters.push_back(new R3BNeulandCluster({
                R3BNeulandHit{
                    1083, 71.0819, 79.2814, 65.5388, 23.3921, 8.39904, 14.0168, { 37.5, 57.3966, 1507.5 }, {} },
                R3BNeulandHit{
                    1084, 71.2626, 79.1224, 65.5497, 64.1623, 24.6824, 39.7954, { 42.5, 55.0182, 1507.5 }, {} },
                R3BNeulandHit{
                    1035, 72.1257, 77.3548, 65.0974, 16.9382, 8.4339, 11.9522, { 36.6034, 47.5, 1502.5 }, {} },
                R3BNeulandHit{
                    1138, 72.5849, 78.9514, 66.1253, 71.6596, 39.9796, 53.5249, { 44.5655, 62.5, 1512.5 }, {} },
                R3BNeulandHit{
                    1036, 71.8915, 77.676, 65.1409, 21.0253, 10.3993, 14.7868, { 40.4911, 52.5, 1502.5 }, {} },
            }));
        }
        ...
        void SetUp() override
        {
            fClusters.push_back(new R3BNeulandCluster(
                ...
                R3BNeulandHit{
                    874, 74.0923, 75.5003, 65.1535, 2.44689, 1.85643, 2.13131, { -7.5, 9.85647, 1487.5 }, {} }));
            fClusters.push_back(new R3BNeulandCluster(R3BNeulandHit{
                627, 70.3447, 73.3119, 62.1854, 24.4598, 18.9215, 21.5131, { 20.7703, 7.5, 1462.5 }, {} }));
            fClusters.push_back(new R3BNeulandCluster({
                // Triggers IsElastic with the Cluster above
                R3BNeulandHit{
                    1032, 72.2410, 76.5411, 64.7482, 45.0953, 23.9844, 32.8874, { 30.1012, 32.5, 1502.5 }, {} },
                R3BNeulandHit{
                    1079, 72.9925, 76.5725, 65.1396, 3.79452, 2.56439, 3.11939, { 17.5, 25.0597, 1507.5 }, {} },
                R3BNeulandHit{
                    1081, 72.0231, 75.9261, 64.3317, 120.891, 83.8838, 100.702, { 27.5, 27.3209, 1507.5 }, {} },
                R3BNeulandHit{
                    1130, 76.3580, 77.9297, 67.5001, 1.53590, 1.30780, 1.41727, { 11.0018, 22.5, 1512.5 }, {} },
            }));
