...
class R3BCalv0 : public R3BDetector
{
 ...
 public:
   ...
   **/
  R3BCalv0(const char* name, Bool_t active);
...
inline Int_t R3BCalv0::GetCrystalType(Int_t volID) {
Int_t type=-1;
...
inline void R3BCalv0::ResetParameters() {
