...
void R3BCal::insertCrystal(xb_crystal *crystal, TGeoVolume **crystalVolumes, TGeoVolume *worldVolume, double r)
{
...
TGeoShape* R3BCal::createCrystal(double *arbCrystals)
{
  double innerR=25.;  //[cm]
  double dZ=10.;      //[cm]
