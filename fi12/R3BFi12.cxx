...
void R3BFi12::Initialize()
{
    ...
    LOG(INFO) << "R3BFi12: initialisation" << FairLogger::endl;
    LOG(DEBUG) << "R3BFi12: Vol. (McId) " << gMC->VolId("FI121Log") << FairLogger::endl;
}

void R3BFi12::SetSpecialPhysicsCuts()
{
    LOG(INFO) << "-I- R3BFi12: Adding customized Physics cut ... " << FairLogger::endl;
...
void R3BFi12::Print(Option_t* option) const
{
    ...
    LOG(INFO) << "R3BFi12: " << nHits << " points registered in this event" << FairLogger::endl;
}
// ----------------------------------------------------------------------------
...
void R3BFi12::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    LOG(INFO) << "R3BFi12: " << nEntries << " entries to add" << FairLogger::endl;
    ...
    LOG(INFO) << "R3BFi12: " << cl2->GetEntriesFast() << " merged entries" << FairLogger::endl;
}
