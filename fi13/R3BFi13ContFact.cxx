...
ClassImp(R3BFi13ContFact)

    static R3BFi13ContFact gR3BFi13ContFact;

R3BFi13ContFact::R3BFi13ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi13ContFact";
    fTitle = "Factory for parameter containers in libR3BFi13";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi13ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi13GeoPar", "Fi13 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi13ContFact::createContainer(FairContainer* c)
{
...
void R3BFi13ContFact::activateParIo(FairParIo* io)
{
