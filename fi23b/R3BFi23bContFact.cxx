...
ClassImp(R3BFi23bContFact)

    static R3BFi23bContFact gR3BFi23bContFact;

R3BFi23bContFact::R3BFi23bContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi23bContFact";
    fTitle = "Factory for parameter containers in libR3BFi23b";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi23bContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi23bGeoPar", "Fi23b geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi23bContFact::createContainer(FairContainer* c)
{
...
void R3BFi23bContFact::activateParIo(FairParIo* io)
{
