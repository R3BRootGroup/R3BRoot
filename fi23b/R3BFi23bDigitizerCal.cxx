...
#include "R3BFi23bDigitizerCal.h"
...
R3BFi23bDigitizerCal::R3BFi23bDigitizerCal()
    : FairTask("R3B Fi23b Digitization scheme ", 1)
    , fFi23bPoints(NULL)
{
}

R3BFi23bDigitizerCal::R3BFi23bDigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi23bDigitizerCal::Init()
{
    ...
    fFi23bCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi23bCal", "Digital response in Fi23b", fFi23bCals, kTRUE);

    fFi23bTriggerCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi23bTriggerCal", "Digital response in Fi23b", fFi23bTriggerCals, kTRUE);
...
void R3BFi23bDigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi23bPoints)
    {
        Digitize(fFi23bPoints, fFi23bCals, fFi23bTriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi23bDigitizerCal::Reset()
{
    if (fFi23bCals)
        fFi23bCals->Clear();
    if (fFi23bTriggerCals)
        fFi23bTriggerCals->Clear();
}

void R3BFi23bDigitizerCal::Finish() {}

ClassImp(R3BFi23bDigitizerCal)
