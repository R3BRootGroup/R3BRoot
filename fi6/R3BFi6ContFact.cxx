...
ClassImp(R3BFi6ContFact)

    static R3BFi6ContFact gR3BFi6ContFact;

R3BFi6ContFact::R3BFi6ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi6ContFact";
    fTitle = "Factory for parameter containers in libR3BFi6";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi6ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi6GeoPar", "Fi6 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi6ContFact::createContainer(FairContainer* c)
{
...
void R3BFi6ContFact::activateParIo(FairParIo* io)
{
