...
void R3BFiberContFact::setAllContainers() {
   ...
   *  the list of containers for the STS library.*/
   /*
    ...
    containers->Add(p2);
    */
    FairContainer* p1= new FairContainer( "Fi3aHitPar",
                                          "Fi3a Hit Parameters",
                                          "TestDefaultContext");
    p1->addContext("TestNonDefaultContext");
    containers->Add(p1);
    
    FairContainer* p2= new FairContainer( "Fi3bHitPar",
                                          "Fi3b Hit Parameters",
                                          "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
    
    FairContainer* p3= new FairContainer( "Fi7HitPar",
                                          "Fi7 Hit Parameters",
                                          "TestDefaultContext");
    p3->addContext("TestNonDefaultContext");
    containers->Add(p3);
    
    FairContainer* p4= new FairContainer( "Fi8HitPar",
                                          "Fi8 Hit Parameters",
                                          "TestDefaultContext");
    p4->addContext("TestNonDefaultContext");
    containers->Add(p4);
    
    FairContainer* p5= new FairContainer( "Fi10HitPar",
                                          "Fi10 Hit Parameters",
                                          "TestDefaultContext");
    p5->addContext("TestNonDefaultContext");
    containers->Add(p5);
    
    FairContainer* p6= new FairContainer( "Fi11HitPar",
                                          "Fi11 Hit Parameters",
                                          "TestDefaultContext");
    p6->addContext("TestNonDefaultContext");
    containers->Add(p6);

    FairContainer* p7= new FairContainer( "Fi12HitPar",
                                          "Fi12 Hit Parameters",
                                          "TestDefaultContext");
    p7->addContext("TestNonDefaultContext");
    
    containers->Add(p7);
    FairContainer* p8= new FairContainer( "Fi13HitPar",
                                          "Fi13 Hit Parameters",
                                          "TestDefaultContext");
