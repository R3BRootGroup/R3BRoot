...
R3BFi12DigitizerCal::R3BFi12DigitizerCal()
    : FairTask("R3B Fi12 Digitization scheme ", 1)
    , fFi12Points(NULL)
{
}

R3BFi12DigitizerCal::R3BFi12DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi12DigitizerCal::Init()
{
    ...
    fFi12Cals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi12Cal", "Digital response in Fi12", fFi12Cals, kTRUE);

    fFi12TriggerCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi12TriggerCal", "Digital response in Fi12", fFi12TriggerCals, kTRUE);
...
void R3BFi12DigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi12Points)
    {
        Digitize(fFi12Points, fFi12Cals, fFi12TriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi12DigitizerCal::Reset()
{
    if (fFi12Cals)
        fFi12Cals->Clear();
    if (fFi12TriggerCals)
        fFi12TriggerCals->Clear();
}

void R3BFi12DigitizerCal::Finish() {}

ClassImp(R3BFi12DigitizerCal)
