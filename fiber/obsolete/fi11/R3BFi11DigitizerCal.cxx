...
R3BFi11DigitizerCal::R3BFi11DigitizerCal()
    : FairTask("R3B Fi11 Digitization scheme ", 1)
    , fFi11Points(NULL)
{
}

R3BFi11DigitizerCal::R3BFi11DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi11DigitizerCal::Init()
{
...
void R3BFi11DigitizerCal::Exec(Option_t* opt)
{
    Reset();
...
void R3BFi11DigitizerCal::Reset()
{
    if (fFi11Cals)
        fFi11Cals->Clear();
    if (fFi11TriggerCals)
