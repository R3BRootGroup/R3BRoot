...
ClassImp(R3BFi11ContFact)

    static R3BFi11ContFact gR3BFi11ContFact;

R3BFi11ContFact::R3BFi11ContFact()
{
...
void R3BFi11ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi11GeoPar", "Fi11 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi11ContFact::createContainer(FairContainer* c)
{
...
void R3BFi11ContFact::activateParIo(FairParIo* io)
{
