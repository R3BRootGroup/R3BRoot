...
R3BFi9DigitizerCal::R3BFi9DigitizerCal()
    : FairTask("R3B Fi9 Digitization scheme ", 1)
    , fFi9Points(NULL)
{
}

R3BFi9DigitizerCal::R3BFi9DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi9DigitizerCal::Init()
{
    ...
    fFi9Points = (TClonesArray*)ioman->GetObject("Fi9Point");

    fMCTrack = (TClonesArray*)ioman->GetObject("MCTrack");

    // Register output array Fib13Digi
    fFi9Cals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi9Cal", "Digital response in Fi9", fFi9Cals, kTRUE);
...
void R3BFi9DigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi9Points)
    {
        Digitize(fFi9Points, fFi9Cals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi9DigitizerCal::Reset()
{
    if (fFi9Cals)
        fFi9Cals->Clear();
}

void R3BFi9DigitizerCal::Finish() {}

ClassImp(R3BFi9DigitizerCal)
