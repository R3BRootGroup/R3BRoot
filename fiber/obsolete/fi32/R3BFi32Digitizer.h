...
#ifndef R3BFI32DIGITIZER_H
#define R3BFI32DIGITIZER_H 1
...
class R3BFi32Digitizer : public FairTask
{
  ...
  public:
    ...
    R3BFi32Digitizer(Double_t esigma, Double_t tsigma, Double_t ysigma);
