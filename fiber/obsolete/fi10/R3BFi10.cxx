...
{
    LOG(info) << "-I- R3BFi10: Adding customized Physics cut ... ";
...
void R3BFi10::Print(Option_t* option) const
{
    ...
    LOG(info) << "R3BFi10: " << nHits << " points registered in this event";
}
// ----------------------------------------------------------------------------
...
void R3BFi10::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    LOG(info) << "R3BFi10: " << nEntries << " entries to add";
    ...
    LOG(info) << "R3BFi10: " << cl2->GetEntriesFast() << " merged entries";
}
