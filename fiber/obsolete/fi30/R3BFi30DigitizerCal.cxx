...
R3BFi30DigitizerCal::R3BFi30DigitizerCal()
    : FairTask("R3B Fi30 Digitization scheme ", 1)
    , fFi30Points(NULL)
{
}

R3BFi30DigitizerCal::R3BFi30DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi30DigitizerCal::Init()
{
...
void R3BFi30DigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi30Points)
    {
        Digitize(fFi30Points, fFi30Cals, fFi30TriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi30DigitizerCal::Reset()
{
    if (fFi30Cals)
        fFi30Cals->Clear();
    if (fFi30TriggerCals)
        fFi30TriggerCals->Clear();
}

void R3BFi30DigitizerCal::Finish() {}

ClassImp(R3BFi30DigitizerCal)
