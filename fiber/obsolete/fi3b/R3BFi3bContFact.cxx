...
ClassImp(R3BFi3bContFact)

    static R3BFi3bContFact gR3BFi3bContFact;

R3BFi3bContFact::R3BFi3bContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi3bContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi3bContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi3bGeoPar", "Fi3b geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi3bContFact::createContainer(FairContainer* c)
{
...
void R3BFi3bContFact::activateParIo(FairParIo* io)
{
