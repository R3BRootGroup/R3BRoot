...
R3BFi3bDigitizerCal::R3BFi3bDigitizerCal()
    : FairTask("R3B Fi3b Digitization scheme ", 1)
    , fFi3bPoints(NULL)
{
}

R3BFi3bDigitizerCal::R3BFi3bDigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi3bDigitizerCal::Init()
{
    ...
    fFi3bPoints = (TClonesArray*)ioman->GetObject("Fi3bPoint");

    fMCTrack = (TClonesArray*)ioman->GetObject("MCTrack");

    // Register output array Fib13Digi
    fFi3bCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi3bCal", "Digital response in Fi3b", fFi3bCals, kTRUE);

    fFi3bTriggerCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi3bTriggerCal", "Digital response in Fi3b", fFi3bTriggerCals, kTRUE);
...
void R3BFi3bDigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi3bPoints)
    {
        Digitize(fFi3bPoints, fFi3bCals, fFi3bTriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi3bDigitizerCal::Reset()
{
    if (fFi3bCals)
        fFi3bCals->Clear();
    if (fFi3bTriggerCals)
        fFi3bTriggerCals->Clear();
}

void R3BFi3bDigitizerCal::Finish() {}

ClassImp(R3BFi3bDigitizerCal)
