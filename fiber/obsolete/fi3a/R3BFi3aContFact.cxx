...
ClassImp(R3BFi3aContFact)

    static R3BFi3aContFact gR3BFi3aContFact;

R3BFi3aContFact::R3BFi3aContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi3aContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi3aContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi3aGeoPar", "Fi3a geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi3aContFact::createContainer(FairContainer* c)
{
...
void R3BFi3aContFact::activateParIo(FairParIo* io)
{
