...
R3BFi13DigitizerCal::R3BFi13DigitizerCal()
    : FairTask("R3B Fi13 Digitization scheme ", 1)
    , fFi13Points(NULL)
{
}

R3BFi13DigitizerCal::R3BFi13DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi13DigitizerCal::Init()
{
...
void R3BFi13DigitizerCal::Exec(Option_t* opt)
{
    Reset();
...
void R3BFi13DigitizerCal::Reset()
{
    if (fFi13Cals)
        fFi13Cals->Clear();
    if (fFi13TriggerCals)
