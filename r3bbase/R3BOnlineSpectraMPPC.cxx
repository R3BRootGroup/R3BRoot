...
InitStatus R3BOnlineSpectraPdc::Init()
{
    ...
    */
    ...
    if (fMappedItems_fi60)
    {
        ...
        fh_fi60_Tot_ave = new TH2F("Fi60_ToT_ave", "Fi60 ToT sum vs. fiber average", ch, 0., ch, 250, 0, 250);
        ...
        fh_fi60_tot2_tot1 =
            new TH2F("Fi60_ToT1_vs_ToT2", "Fi60 ToT1 vs. ToT2", int(60. / 0.4167), 0, 60, int(60. / 0.4167), 0, 60);
