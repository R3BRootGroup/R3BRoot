...
#ifndef R3BONLINESPECTRAS494
#define R3BONLINESPECTRAS494
 ...
 * for online checks.
 */
class R3BOnlineSpectraS494 : public FairTask
{
  ...
  public:
     ...
     */
    R3BOnlineSpectraS494(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BOnlineSpectraS494();
...
#define NOF_FIB_DET (DET_FI_LAST - DET_FI_FIRST + 1)
    ...
    const char* fDetectorNames[DET_MAX + 1] = { "Ams",  "Califa", "BeamMonitor", "Fi1a",  "Fi1b",    "Fi2a",
                                                ...
                                                "Fi13",  "Fi31", "L3t",    "Los",         "Music", "Neuland", "Pspx",
    ...
    Double_t n_fiber[NOF_FIB_DET] = { 256.,  256.,  256., 256,  512., 512.,  2048.,
                                      2048., 1024., 512., 512., 512., 1024., 1024., 512 };
  ...
  public:
    ClassDef(R3BOnlineSpectraS494, 2)
};
