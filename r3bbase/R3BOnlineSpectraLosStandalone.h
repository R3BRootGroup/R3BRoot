...
class R3BOnlineSpectraLosStandalone : public FairTask
{
  ...
  public:
    ...
    /* Method for pile-up */
    inline void SetEpileup(Double_t Epileup)
    {
		fEpileup = Epileup;
	}
	...
	fh_losX_vs_Events.resize(nDets);
    ...
    void Reset_TRIG_Histo();
     
  private:
    std::vector<TClonesArray *> fMappedItems;
    std::vector<TClonesArray *> fCalItems;
    
    TClonesArray* fWRLos; /**< Array with mapped items. */
 ...
 //   TClonesArray *fbmonMappedItems;
    ...
    Double_t time_clear = -1., time_act, time_test;
    Double_t tdiff = 0.;
    Double_t fNorm = 1.;
    Double_t fEpileup;
    ...
    std::vector<TH2F *> fh_losX_vs_Events;
