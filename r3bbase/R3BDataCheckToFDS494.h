...
#ifndef R3BDATACHECKTOFDS494
#define R3BDATACHECKTOFDS494
 ...
 * for online checks.
 */
class R3BDataCheckToFDS494 : public FairTask
{ 
  ...
  public:
     ...
     */
    R3BDataCheckToFDS494(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BDataCheckToFDS494();
  ...
  public:
    ClassDef(R3BDataCheckToFDS494, 2)
};
