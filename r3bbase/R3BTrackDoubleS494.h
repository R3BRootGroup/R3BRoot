...
#ifndef R3BTRACKDOUBLES494
#define R3BTRACKDOUBLES494
 ...
 * for online checks.
 */
class R3BTrackDoubleS494 : public FairTask
{
  ...
  public:
     ...
     */
    R3BTrackDoubleS494(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTrackDoubleS494();
