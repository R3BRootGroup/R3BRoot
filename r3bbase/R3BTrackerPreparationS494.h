...
#ifndef R3BTRACKERPREPARATIONS494
#define R3BTRACKERPREPARATIONS494
 ...
 * for online checks.
 */
class R3BTrackerPreparationS494 : public FairTask
{
  ...
  public:
     ...
     */
    R3BTrackerPreparationS494(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTrackerPreparationS494();
...
//	Double_t mC = 12. * amu;
  ...
  public:
    ClassDef(R3BTrackerPreparationS494, 1)
};
