...
#ifndef R3BONLINESPECTRALOSTEST
#define R3BONLINESPECTRALOSTEST
 ...
 * for online checks.
 */
class R3BOnlineSpectraLosTest : public FairTask
{
  ...
  public:
     ...
     */
    R3BOnlineSpectraLosTest(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BOnlineSpectraLosTest();
