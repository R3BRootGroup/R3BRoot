...
*/       if (det == 6)
    ...
    for (Int_t ifibcount = 0; ifibcount < NOF_FIB_DET; ifibcount++)
    {
		//cout<<"In the loop for ifibcout= "<<ifibcount<<endl;
            ...
            // xy:
            fh_xy_Fib[ifibcount] =
                new TH2F(Form("%s_xToFDtotFib", detName), Form("%s ToTFib vs xToFD", detName), 1200, -60., 60., 400, 0., 100.);
            ...
            fh_xy_Fib_ac[ifibcount] = new TH2F(
                Form("%s_xToFDtotFib_ac", detName), Form("%s ToTFib vs xToFD after cuts", detName), 1200, -60., 60., 400, 0., 100.);
            fh_xy_Fib_ac[ifibcount]->GetXaxis()->SetTitle("xToFD / cm ");
            fh_xy_Fib_ac[ifibcount]->GetYaxis()->SetTitle("ToT Fib / ns");

            // ToT vs xToFD:
            fh_ToT_Fib[ifibcount] =
                new TH2F(Form("%s_totFib_vs_totToFD", detName), Form("%s ToTFib vs totToFD", detName), 800, 0., 200., 400, 0., 100.);
            ...
            // ToF Tofd -> Fiber:
            fh_Fib_ToF[ifibcount] = new TH1F(
                Form("%s_tof", detName), Form("%s ToF Tofd to Fiber", detName), 10000, -1100., 1100.);
            fh_Fib_ToF[ifibcount]->GetXaxis()->SetTitle("ToF / ns");
            fh_Fib_ToF[ifibcount]->GetYaxis()->SetTitle("counts");

            fh_Fib_ToF_ac[ifibcount] = new TH1F(Form("%s_tof_ac", detName),
           ...
           fh_counter_fi30 = new TH2F("Counts_Fi30_vs_ToFD","Fib30 efficiency",
                                                  10000,
                                                   0,
                                                   100000, //Nmax,
                                                  2000,
           ...
           fh_counter_fi31 = new TH2F("Counts_Fi31_vs_ToFD","Fib31 efficiency",
                                                  10000,
                                                   0,
                                                   100000, //Nmax,
                                                  2000,
            ...
            fh_counter_fi32 = new TH2F("Counts_Fi32_vs_ToFD","Fib32 efficiency",
                                                  10000,
                                                   0,
                                                   100000, //Nmax,
                                                  2000,
           ...
           fh_counter_fi33 = new TH2F("Counts_Fi33_vs_ToFD","Fib33 efficiency",
                                                 10000,
                                                   0,
                                                   100000, //Nmax,
                                                  2000,
           ...
           cFib->cd(1);gPad->SetLogy();
           fh_Fib_ToF[0]->Draw();                                
           cFib->cd(2);gPad->SetLogz();
           fh_ToT_Fib[0]->Draw("colz");
           cFib->cd(3);gPad->SetLogz();
           fh_Fibs_vs_Tofd[0]->Draw("colz");          
           cFib->cd(4);gPad->SetLogz();
           fh_xy_Fib[0]->Draw("colz");
           
           cFib->cd(6);gPad->SetLogy();
           fh_Fib_ToF[1]->Draw();                                
           cFib->cd(7);gPad->SetLogz();
           fh_ToT_Fib[1]->Draw("colz");
           cFib->cd(8);gPad->SetLogz();
           fh_Fibs_vs_Tofd[1]->Draw("colz");
           cFib->cd(9);gPad->SetLogz();
           fh_xy_Fib[1]->Draw("colz");
           
           cFib->cd(11);gPad->SetLogy();
           fh_Fib_ToF[2]->Draw();                                
           cFib->cd(12);gPad->SetLogz();
           fh_ToT_Fib[2]->Draw("colz");
           cFib->cd(13);gPad->SetLogz();
           fh_Fibs_vs_Tofd[2]->Draw("colz");
           cFib->cd(14);gPad->SetLogz();
           fh_xy_Fib[2]->Draw("colz");
           cFib->cd(15);gPad->SetLogz();
           fh_counter_fi30->Draw("colz");
           
           cFib->cd(16);gPad->SetLogy();
           fh_Fib_ToF[3]->Draw();                                
           cFib->cd(17);gPad->SetLogz();
           fh_ToT_Fib[3]->Draw("colz");
           cFib->cd(18);gPad->SetLogz();
           fh_Fibs_vs_Tofd[3]->Draw("colz");
           cFib->cd(19);gPad->SetLogz();
           fh_xy_Fib[3]->Draw("colz");
           cFib->cd(20);gPad->SetLogz();
           fh_counter_fi31->Draw("colz");
           
           cFib->cd(21);gPad->SetLogy();
           fh_Fib_ToF[4]->Draw();                                
           cFib->cd(22);gPad->SetLogz();
           fh_ToT_Fib[4]->Draw("colz");
           cFib->cd(23);gPad->SetLogz();
           fh_Fibs_vs_Tofd[4]->Draw("colz");
           cFib->cd(24);gPad->SetLogz();
           fh_xy_Fib[4]->Draw("colz");
           cFib->cd(25);gPad->SetLogz();
           fh_counter_fi32->Draw("colz");
           
           cFib->cd(26);gPad->SetLogy();
           fh_Fib_ToF[5]->Draw();                                
           cFib->cd(27);gPad->SetLogz();
           fh_ToT_Fib[5]->Draw("colz");
           cFib->cd(28);gPad->SetLogz();
           fh_Fibs_vs_Tofd[5]->Draw("colz");
           cFib->cd(29);gPad->SetLogz();
           fh_xy_Fib[5]->Draw("colz");
           cFib->cd(30);gPad->SetLogz();
           fh_counter_fi33->Draw("colz");
      //     cFib->cd(0);
       
       //    run->AddObject(cFib);
      //     run->GetHttpServer()->RegisterCommand("Reset_Fib",
      //                                        Form("/Tasks/%s/->Reset_Fib()", GetName()));
...
void R3BOnlineSpectraFibvsToFDS494::Exec(Option_t* option)
{
    ...
    for (Int_t ihit = 0; ihit < nHits; ihit++)
    {
        ...
        if(hitTofd->GetDetId() != 12 ) continue;  // both planes 1&2 have hit
        nHitstemp += 1;
 ...
 //       cout<<"tofd: "<<xxx<<", "<<icc<<", "<<ncounts_tofd[icc]<<endl;
        ...
        if (fCuts && (qqq < 0 || qqq > 1000))
                    continue;
        if(fCuts && (xxx < -10000 || xxx > 10000)) continue;
        ...
        if(nHitstemp == 1 && nHits33 > 0 && tofd_right) events33++;
        ...
        LOG(DEBUG) << "Fi31 hits: " << nHits31 << endl;
         if(nHitstemp == 1 && nHits31 > 0 && tofd_right) events31++;
        ...
        LOG(DEBUG) << "Fi30 hits: " << nHits30 << endl;
         if(nHitstemp == 1 && nHits30 > 0 && tofd_left) events30++;
        ...
        LOG(DEBUG) << "Fi32 hits: " << nHits32 << endl;
         if(nHitstemp == 1 && nHits32 > 0 && tofd_left) events32++;
        ...
        for (Int_t ihit23a = 0; ihit23a < nHits23a; ihit23a++)
        {
            ...
            fh_xy_Fib[det]->Fill(x1[det], y1[det]),
            fh_ToT_Fib[det]->Fill(qqq, q1[det]);
            fh_Fibs_vs_Tofd[det]->Fill(xxx, x1[det] );
            fh_ToF_vs_Events[det]->Fill(fNEvents, tof);
...
void R3BOnlineSpectraFibvsToFDS494::FinishTask()
{
    ...
    cout << "TofD multi - " <<"left: "<<summ_tofdl<<", right: "<<summ_tofdr << endl;
