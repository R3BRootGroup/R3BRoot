...
#ifndef R3BONLINESPECTRAFIBER23
#define R3BONLINESPECTRAFIBER23
 ...
 * for online checks.
 */
class R3BOnlineSpectraFiber23 : public FairTask
{
  ...
  public:    
     ...
     */
    R3BOnlineSpectraFiber23(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BOnlineSpectraFiber23();
...
#define NOF_FIB_DET (DET_FI_LAST - DET_FI_FIRST + 1)
    ...
    const char* fDetectorNames[DET_MAX + 1] = { "Fi23a", "Fi23b", NULL };
    ...
    TH2F *fh_dtime_Fib23;
  public:
    ClassDef(R3BOnlineSpectraFiber23, 2)
};
