...
R3BLmdSource::R3BLmdSource()
  : FairMbsSource(),
    ...
    fBufNeuLand(new TClonesArray("R3BNeulandRawItem")),
    fTSUnit(1),
    fDelayCutLower(250),
    fDelayCutUpper(380),
    fCurrentFile(0),
...
void R3BLmdSource::CopyNeuLandToBuf()
{
    ...
    {
        new ((*fBufNeuLand)[i]) R3BNeulandRawItem(*((R3BNeulandRawItem*)fNeuLandHits->At(i)));
    }
}
...
void R3BLmdSource::CopyNeuLandToOutput()
{
    ...
    {
        new ((*fNeuLandHits)[i]) R3BNeulandRawItem(*((R3BNeulandRawItem*)fBufNeuLand->At(i)));
    }
