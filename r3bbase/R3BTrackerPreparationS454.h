...
// -----            Created 30-11-2020 by M.Heil          -----
// -----               prepare data for tracking             -----
// ------------------------------------------------------------

#ifndef R3BTRACKERPREPARATIONS454
#define R3BTRACKERPREPARATIONS454
 ...
 * for online checks.
 */
class R3BTrackerPreparationS454 : public FairTask
{
  ...
  public:
     ...
     */
    R3BTrackerPreparationS454(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTrackerPreparationS454();
  ...
  private:
    ...
    TClonesArray* fFi3aHitItems;       
    Int_t fNofFi3aHitItems;
    TClonesArray* fFi3bHitItems;       
    Int_t fNofFi3bHitItems;
    TClonesArray* fFi10HitItems;       
    Int_t fNofFi10HitItems;
    TClonesArray* fFi11HitItems;       
    Int_t fNofFi11HitItems;
    TClonesArray* fFi12HitItems;       
    Int_t fNofFi12HitItems;
    TClonesArray* fFi13HitItems;       
    Int_t fNofFi13HitItems;
...
//	Double_t mC = 12. * amu;
  ...
  public:
    ClassDef(R3BTrackerPreparationS454, 1)
};
