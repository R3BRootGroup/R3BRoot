...
ClassImp(R3BFi33ContFact)

    static R3BFi33ContFact gR3BFi33ContFact;

R3BFi33ContFact::R3BFi33ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi33ContFact";
    fTitle = "Factory for parameter containers in libR3BFi33";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi33ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi33GeoPar", "Fi33 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi33ContFact::createContainer(FairContainer* c)
{
...
void R3BFi33ContFact::activateParIo(FairParIo* io)
{
