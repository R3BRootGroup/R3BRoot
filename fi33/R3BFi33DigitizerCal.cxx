...
R3BFi33DigitizerCal::R3BFi33DigitizerCal()
    : FairTask("R3B Fi33 Digitization scheme ", 1)
    , fFi33Points(NULL)
{
}

R3BFi33DigitizerCal::R3BFi33DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi33DigitizerCal::Init()
{
    ...
    fFi33Cals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi33Cal", "Digital response in Fi33", fFi33Cals, kTRUE);

    fFi33TriggerCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi33TriggerCal", "Digital response in Fi33", fFi33TriggerCals, kTRUE);
...
void R3BFi33DigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi33Points)
    {
        Digitize(fFi33Points, fFi33Cals, fFi33TriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi33DigitizerCal::Reset()
{
    if (fFi33Cals)
        fFi33Cals->Clear();
    if (fFi33TriggerCals)
        fFi33TriggerCals->Clear();
}

void R3BFi33DigitizerCal::Finish() {}

ClassImp(R3BFi33DigitizerCal)
