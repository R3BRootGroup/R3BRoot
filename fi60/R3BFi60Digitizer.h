...
#ifndef R3BFI60DIGITIZER_H
#define R3BFI60DIGITIZER_H 1
...
class R3BFi60Digitizer : public FairTask
{
  ...
  public:
    ...
    R3BFi60Digitizer(Double_t esigma, Double_t tsigma, Double_t ysigma);
