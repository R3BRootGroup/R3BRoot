...
ClassImp(R3BFi60ContFact)

    static R3BFi60ContFact gR3BFi60ContFact;

R3BFi60ContFact::R3BFi60ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi60ContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi60ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi60GeoPar", "Fi60 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi60ContFact::createContainer(FairContainer* c)
{
...
void R3BFi60ContFact::activateParIo(FairParIo* io)
{
