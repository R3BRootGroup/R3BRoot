...
R3BLandPoint::R3BLandPoint(Int_t trackID,
                           Int_t detID,
                           Int_t box,
                           Int_t sector,
                           Int_t paddle,
...
{
    cout << "-I- R3BLandPoint: LAND Point for track " << fTrackID << " in detector " << fDetectorID
         << " Sector: " << fSector << " PaddleTyp: " << fPaddleTyp << " PaddleNb: " << fPaddleNb << endl;
