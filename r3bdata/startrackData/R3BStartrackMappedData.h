...
public:
   ...
   *@param timehb      intermediate bits of the external signal time stamp (very high bit: 28 to 47)     -> 20 bits in total
   *@param timelb      more significant bit of the external signal time stamp (very high bit: 0 to 27)   -> 28 bits in total
   *@param ADCdata     Total energy deposited in the crystal [a.u.]
   *@param infofield   other information 
   *@param infocode    Code associated to the type of the above information (infofield)
   **/
  //  R3BStartrackMappedData(UInt_t wrvhb, UInt_t wrhb, UInt_t wrlb, Int_t wordtype, Int_t hitbit, Int_t ladderId, Int_t side, Int_t asicId, Int_t stripId, UInt_t adc_data, UInt_t timevhb, UInt_t timehb, UInt_t timelb, UInt_t timeExtvhb, UInt_t timeExthb, UInt_t timeExtlb, Int_t infofield, Int_t infocode);
  R3BStartrackMappedData(ULong_t ts, ULong_t tsext,Int_t wordtype, Int_t hitbit, Int_t ladderId, Int_t side, Int_t asicId, Int_t stripId, UInt_t adc_data, UInt_t timevhb, UInt_t timehb, UInt_t timelb, UInt_t timeExtvhb, UInt_t timeExthb, UInt_t timeExtlb, Int_t infofield, Int_t infocode);
