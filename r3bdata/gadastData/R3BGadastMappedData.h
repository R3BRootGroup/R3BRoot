...
// -------------------------------------------------------------------------
// -----              R3BGadastMappedData header file                   -----
// -----         Created 15/10/19 by J.L. Rodriguez-Sanchez            -----
// -------------------------------------------------------------------------

#ifndef R3BGadastMappedData_H
#define R3BGadastMappedData_H 1

#include "TObject.h"

class R3BGadastMappedData : public TObject
{
  public:
    /** Default constructor **/
    R3BGadastMappedData();
     ...
     **/
    R3BGadastMappedData(UShort_t anodeID, UShort_t time, UShort_t energy);

    /** Destructor **/
    virtual ~R3BGadastMappedData() {}
  ...
  private:
    ...
    ClassDef(R3BGadastMappedData, 1)
};
