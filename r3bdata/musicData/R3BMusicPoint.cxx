...
R3BMusicPoint::R3BMusicPoint(Int_t trackID, Int_t detID, Int_t detCopyID,
...
void R3BMusicPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BMusicPoint: STS Point for track " << fTrackID 
...
Double_t R3BMusicPoint::GetY(Double_t z) const {
