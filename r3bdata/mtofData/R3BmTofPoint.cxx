...
// -----   Default constructor   -------------------------------------------
R3BmTofPoint::R3BmTofPoint() : FairMCPoint() {
...
R3BmTofPoint::R3BmTofPoint(Int_t trackID, Int_t detID, TVector3 posIn, 
...
void R3BmTofPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BmTofPoint: STS Point for track " << fTrackID 
