...
class R3BFootHitData : public TObject
{
  public:
     ...
     *@param fZCharge   Ion atomic charge
     **/
    ...
    [[nodiscard]] inline const double& GetZCharge() const { return fZCharge; }
  ...
  protected:
    ...
    double fEta = 0;
    double fZCharge = std::nan("");

  public:
    ClassDefOverride(R3BFootHitData, 2); // NOLINT
};
