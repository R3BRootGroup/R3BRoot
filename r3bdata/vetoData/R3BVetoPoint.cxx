...
R3BVetoPoint::R3BVetoPoint(Int_t trackID, Int_t detID, Int_t box, Int_t sector, Int_t paddle, TVector3 posIn, 
...
void R3BVetoPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BVetoPoint: STS Point for track " << fTrackID 
