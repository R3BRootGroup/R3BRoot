...
// -----   Default constructor   -------------------------------------------
R3BPspPoint::R3BPspPoint() : FairMCPoint() {
...
R3BPspPoint::R3BPspPoint(Int_t trackID, Int_t detID, Int_t plane, TVector3 posIn,
...
void R3BPspPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BPspPoint: STS Point for track " << fTrackID 
