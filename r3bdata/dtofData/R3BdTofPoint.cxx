...
// -----   Default constructor   -------------------------------------------
R3BdTofPoint::R3BdTofPoint() : FairMCPoint() {
...
R3BdTofPoint::R3BdTofPoint(Int_t trackID, Int_t detID, TVector3 posIn, 
...
void R3BdTofPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BdTofPoint: STS Point for track " << fTrackID 
