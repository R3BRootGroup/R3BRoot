...
class R3BTrackingS515 : public FairTask
{
    public:
        ...
        void SetMusicZMinMax(double min, double max){ MusicZMin=min; MusicZMax=max; }
        void SetFRSBrhoMinMax(double min, double max){ FrsBrhoMin=min; FrsBrhoMax=max; }
...
#define NOF_FIB_DET (DET_FI_LAST - DET_FI_FIRST + 1)
        ...
        {
            "Fi10Hit",  "Fi11Hit",  "Fi12Hit", "TofdHit",
            "Mwpc0HitData", "FrsData", "MusicHitData",
            "LosHit", 
            NULL 
        };
