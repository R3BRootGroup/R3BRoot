...
#ifndef R3BFRAGMENTFITTERCHI2PAS
#define R3BFRAGMENTFITTERCHI2PAS
...
class R3BFragmentFitterChi2PAS : public R3BFragmentFitterGeneric
{
  public:
    R3BFragmentFitterChi2PAS();
    ~R3BFragmentFitterChi2PAS();
  ...
  private:
    ...
    ClassDef(R3BFragmentFitterChi2PAS, 1)
};
