...
void R3BOptimizeGeometryS454::Finish()
{
    ...
    if (fLeft)
    {
        ...
        // //chi=613 Double_t variable[9] = {-94.46,  667.8,  -67.73,  583.4,  -18.19, -17.08,  1.0, 5.31, 80.49};
        // //chi= Double_t variable[9] = {-94.46,  667.9 , -67.73,  583.4,  -18.39, -17.28,  1.000,  5.310 , 80.49};
        // //chi=2672 Double_t variable[9] = {-94.52,  667.8 , -67.73,  583.2,  -18.58, -17.48,  1.000,  5.310 , 80.47};
        // //chi=2283 Double_t variable[9] = {-94.49,  667.8 , -67.73,  583.2,  -18.74, -17.61,  0.9897,  5.390
        // , 80.53}; //chi=910 Double_t variable[9] = {-94.45,  667.8 , -67.73,  583.0,  -18.72, -17.31,  0.9897,  5.390
        // , 80.53}; //chi=910 Double_t variable[9] = {-94.58,  667.8 , -67.73,  583.0,  -18.78, -17.27,  0.9997,  5.52
        // , 80.59}; //chi=919 best with 4He and 12C Double_t variable[9] = {-94.72,  667.8 , -67.62,  583.0,  -19.00,
        // -16.95,  0.9997,  5.6 , 80.65}; //chi=532 only 4He Double_t variable[9] = {-94.62,  667.8 , -67.62,  583.0,
        // -18.97, -16.95, 0.9997, 5.6 , 80.65}; //chi=532 only 4He Double_t variable[9] = {-94.62,  668.2 , -67.38,
        // 582.9,  -19.37, -16.88, 1.019,  5.59 , 80.47}; //chi=3313 only 4He Double_t variable[9] = {-94.46,  667.8 ,
        // -67.73,  583.4,  -18.15, -17.10,  1.0,  5.31 , 80.49}; //chi=3313 only 12C Double_t variable[9] = {-94.56,
        // 667.8 , -67.73,  583.4, -18.25, -17.06,  1.0,  5.31 , 80.49}; //chi=3693 only 12C Double_t variable[9] =
        // {-94.63,  667.8 , -67.73, 583.4,  -18.68, -17.28,  1.009,  5.45 , 80.50}; //chi=3754 only 12C
        ...
        // variable[9] = {-94.00,  668.3 , -67.57,  583.5,  -17.52, -17.59,  0.9570,  4.91 , 80.77}; //chi=15.15 only
        // 12C
    ...
    else
    {
        ...
        // 676.4,  -198.6,  -196.4,  0.98,  -5.270,  80.68}; // chi=5514 Double_t variable[9] = { -129.6,  589.5,
        // -158.1, 676.4,  -198.8,  -196.4,  0.9997,  -5.270,  80.67}; // chi=5700 Double_t variable[9] = { -129.6,
        // 589.5, -158.1,  676.4,  -198.7,  -196.4,  0.9997,  -5.270,  80.67}; // chi=5439  best with 4He and 12C
        // Double_t variable[9] = { -129.5,  589.5,  -158.0,  676.4,  -198.2,  -196.4,  0.9997,  -5.210,  80.64}; //
        // chi=2291 only 4He Double_t variable[9] = { -129.6,  589.5,  -158.0,  676.5,  -198.4,  -196.5,  1.013, -5.11,
        // 80.61}; // chi=37677  only 12C Double_t variable[9] = { -129.7,  589.6,  -158.1,  676.5,  -198.4,  -196.6,
        // 1.013, -5.28, 80.58}; // chi=7418  only 4He Double_t variable[9] = { -129.7,  589.6,  -158.1,  676.0, -198.8,
        // -196.4, 1.0, -5.31,  80.67}; // chi=7418  only 4He Double_t variable[9] = { -129.6,  589.5,  -158.1,  676.0,
        // -198.9, -196.5,  1.011,  -5.2,  80.54}; // chi=7955  only 4He
        ...
        // variable[9] = { -128.1,  587.5,  -156.3,  674.7,  -198.1,  -198.1,  0.9570,  -5.45,  80.89}; // chi=12.08
        // only 12C
        ...
        // chi=10.77  only 12C Double_t variable[9] = { -128.1,  587.6,  -156.3,  674.7,  -198.1,  -197.9,  0.961,
        // -5.46, 80.91}; // chi=10.77  only 12C

        // 12C und mit Zwang auf mag = 1.009
        // Double_t variable[9] = { -128.3,  587.8,  -156.5,  674.6,  -198.0,  -197.9,  1.009,  -5.27,  81.06}; //
        // chi=20.47  only 12C Double_t variable[9] = { -128.2,  587.8,  -156.6,  674.7,  -198.2,  -197.7,  1.009,
        // -5.09, 81.06}; // chi=15.72  only 12C Double_t variable[9] = { -128.1,  587.8,  -156.7,  674.7,  -198.4,
        // -197.7, 1.009,  -4.89,  81.02}; // chi=12.31  only 12C Double_t variable[9] = { -128.1,  587.8,  -156.7,
        // 674.7, -198.4,  -197.7,  1.009,  -4.89,  80.95}; // chi=11.93  only 12C Double_t variable[9] = { -128.1,
        // 587.8, -156.7,  674.7,  -198.4,  -197.5,  1.009,  -4.89,  80.96}; // chi=11.85  only 12C
        ...
        // 80.88}; // chi=7.56 Double_t variable[9] = { -128.1,  587.7,  -156.3,  674.6,  -198.5,  -197.4,  1.006,
        // -5.44, 80.88}; // chi=7.50 Double_t variable[9] = { -128.1,  587.7,  -156.3,  674.6,  -198.7,  -197.5, 1.006,
        // -5.44, 80.88}; // chi=7.50
