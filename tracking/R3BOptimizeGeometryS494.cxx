...
void R3BOptimizeGeometryS494::Finish()
{
    ...
    else
    {
        Double_t variable[10] =
            ...
            // Impuls { -112.6823, 538.3641, -133.0637, 601.9834, -193.5327, -193.6697, 0.25, -0.65, 0.1, 91.37 }; //
            // chi = 343.5 mit 0.001 beim Impuls gleiche Werte für Fib23
            ...
            // 599.8083, -192.7725, -195.2901, 0., 0., 0., 91.2 }; // chi=  with momentum contribution and sigmap =
            // 0.001 and 1000 events { -111.1159, 537.5371, -131.0557, 599.8291, -192.6704, -195.2880, 1., 0., 0., 91.2
            // }; // chi=  with momentum contribution and sigmap = 0.001 and 1000 events { -111.0873, 537.5657,
            ...
            // chi2=4.09  sigmap=0.001 { -111.5004, 538.0370, -130.9630, 599.6890, -193.9882, -193.9782, 1., 0.,
            // 0., 91.2
