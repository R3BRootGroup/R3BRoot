...
void R3BLosTcalFill::CalculateParams(Int_t iModule)
{
    ...
    LOG(INFO) << "R3BLosTcalFill::CalculateParams() : Range of channels: " << iMin << " - " << iMax << FairLogger::endl;
