...
// -----   Default constructor   -------------------------------------------
R3BXBallv0::R3BXBallv0() : R3BDetector("R3BXBallv0", kTRUE, kCAL) {
  ResetParameters();
...
void R3BXBallv0::Initialize()
{
  FairDetector::Initialize();
   ...
   cout << endl;
    cout << "-I- R3BXBallv0 initialisation" << endl;
    cout << "-I- R3BXBallv0: Vol. (McId)" << endl;
    cout << "-I- R3BXBallv0: Crystal A   : " << gMC->VolId("crystalLogNAJA")<< endl;
    cout << "-I- R3BXBallv0: Crystal B   : " << gMC->VolId("crystalLogNAJB")<< endl;
    cout << "-I- R3BXBallv0: Crystal C   : " << gMC->VolId("crystalLogNAJC")<< endl;
    cout << "-I- R3BXBallv0: Crystal D   : " << gMC->VolId("crystalLogNAJD")<< endl;
...
void R3BXBallv0::SetSpecialPhysicsCuts(){

   cout << endl;

   cout << "-I- R3BXBallv0: Adding customized Physics cut ... " << endl;
   cout << "-I- R3BXBallv0: Yet not implemented !... " << endl;
...
void R3BXBallv0::Print() const {
  ...
  cout << "-I- R3BXBallv0: " << nHits << " points registered in this event." 
       << endl;
}
// ----------------------------------------------------------------------------
...
void R3BXBallv0::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset) {
  ...
  cout << "-I- R3BXBallv0: " << nEntries << " entries to add." << endl;
  ...
  R3BXBallPoint* oldpoint = NULL;
   ...
   cout << " -I- R3BXBallv0: " << cl2->GetEntriesFast() << " merged entries."
       << endl;
}

// -----   Private method AddHit   --------------------------------------------
R3BXBallPoint* R3BXBallv0::AddHit(Int_t trackID, Int_t detID, Int_t type, Int_t cp, TVector3 posIn,
  ...
  if (fVerboseLevel>1) 
    cout << "-I- R3BXBallv0: Adding Point at (" << posIn.X() << ", " << posIn.Y() 
...
void R3BXBallv0::ConstructGeometry() {
...
void R3BXBallv0::ConstructGeometry1() {
    cout << endl;
    cout << "-I-  R3BXBallv0 Dummy function called !!! " << endl;
