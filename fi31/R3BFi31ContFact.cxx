...
ClassImp(R3BFi31ContFact)

    static R3BFi31ContFact gR3BFi31ContFact;

R3BFi31ContFact::R3BFi31ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi31ContFact";
    fTitle = "Factory for parameter containers in libR3BFi31";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi31ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi31GeoPar", "Fi31 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi31ContFact::createContainer(FairContainer* c)
{
...
void R3BFi31ContFact::activateParIo(FairParIo* io)
{
