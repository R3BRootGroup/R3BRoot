...
// Medium: CH2
   ...
   // Volume: World
   pWorld_82aa440 = new TGeoVolume("World",pWorld_1, pMed2);
   pWorld_82aa440->SetVisLeaves(kTRUE);

   // SET TOP VOLUME OF GEOMETRY
   gGeoManager->SetTopVolume(pWorld_82aa440);
   ...
   theta = 45.000000;
   phi   = -180.000000;
   TGeoShape *pPara45deg_2 = new TGeoPara("Para45deg",dx,dy,dz,alpha,theta,phi);
   // Volume: Para45deg
   pPara45deg_82aaef8 = new TGeoVolume("Para45deg",pPara45deg_2, pMed16);
   pPara45deg_82aaef8->SetVisLeaves(kTRUE);
   pWorld_82aa440->AddNode(pPara45deg_82aaef8, 0, pMatrix2);
