...
// Material: Lead
   ...
   radl    = 0.561705;
   absl    = 182.471644;
   pMat27 = new TGeoMaterial("Lead", a,z,density,radl,absl);
   pMat27->SetIndex(26);
// Medium: Lead
   ...
   par[6]  = 0.000000; // epsil
   par[7]  = 0.000000; // stmin
   pMed27 = new TGeoMedium("Lead", numed,pMat27, par);
   ...
   // Volume: World
   pWorld_82aa340 = new TGeoVolume("World",pWorld_1, pMed2);
   pWorld_82aa340->SetVisLeaves(kTRUE);

   // SET TOP VOLUME OF GEOMETRY
   gGeoManager->SetTopVolume(pWorld_82aa340);
   ...
   dy = 1.200000;
   dz = 0.008810;
   TGeoShape *pLeadTarget_2 = new TGeoBBox("LeadTarget", dx,dy,dz);
   // Volume: leadTarget_log
   pleadTarget_log_82aadb8 = new TGeoVolume("leadTarget_log",pLeadTarget_2, pMed27);
   pleadTarget_log_82aadb8->SetVisLeaves(kTRUE);
   pWorld_82aa340->AddNode(pleadTarget_log_82aadb8, 0, pMatrix2);
