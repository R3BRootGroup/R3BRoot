...
// Medium: Aluminum
   ...
   // Volume: World
   pWorld_82ab420 = new TGeoVolume("World",pWorld_1, pMed2);
   pWorld_82ab420->SetVisLeaves(kTRUE);

   // SET TOP VOLUME OF GEOMETRY
   gGeoManager->SetTopVolume(pWorld_82ab420);
   ...
   pWorld_82ab420->AddNode(pSiVacuumLogWorld_82abed8, 0, pMatrix2);
