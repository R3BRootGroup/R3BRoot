...
#ifndef R3BFI61DIGITIZER_H
#define R3BFI61DIGITIZER_H 1
...
class R3BFi61Digitizer : public FairTask
{
  ...
  public:
    ...
    R3BFi61Digitizer(Double_t esigma, Double_t tsigma, Double_t ysigma);
