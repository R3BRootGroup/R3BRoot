...
R3BFi61Digitizer::R3BFi61Digitizer()
...
R3BFi61Digitizer::R3BFi61Digitizer(Double_t e, Double_t t, Double_t y)
    : FairTask("R3B Fi61 Digitization scheme ")
    , fFi61Points(NULL)
{
...
void R3BFi61Digitizer::SetEnergyResolution(Double_t e) { esigma = e; }

void R3BFi61Digitizer::SetTimeResolution(Double_t t) { tsigma = t; }

void R3BFi61Digitizer::SetYPositionResolution(Double_t y) { ysigma = y; }

InitStatus R3BFi61Digitizer::Init()
{
    ...
    fFi61Hits = new TClonesArray("R3BBunchedFiberHitData", 1000);
...
void R3BFi61Digitizer::Exec(Option_t* opt)
{
    Reset();
    ...
    auto Digitize = [this](TClonesArray* Points, TClonesArray* Hits, Int_t NumOfFibers) {
        ...
        /*
                ...
                {
                    R3BFibPoint* aTrack = (R3BFibPoint*)fFi61Points->At(l);

                if(aTrack->GetModule()==43 || aTrack->GetModule()==45 || aTrack->GetModule()==52)
           cout<<setprecision(10)<<"From Fi61Points: "<<l<<", "<<aTrack->GetModule()<<", "<<aTrack->GetXIn()<<";
           "<<aTrack->GetXOut()<<endl;
...
void R3BFi61Digitizer::Reset()
{
    if (fFi61Hits)
        fFi61Hits->Clear();
}

void R3BFi61Digitizer::Finish() {}

ClassImp(R3BFi61Digitizer)
