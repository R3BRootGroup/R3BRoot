...
// R3BFi61DigitizerCal.h

#ifndef R3BFI61DIGITIZERCAL_H
#define R3BFI61DIGITIZERCAL_H 1
...
class R3BFi61DigitizerCal : public FairTask
{
  ...
  public:
    ...
    R3BFi61DigitizerCal(const char* name, Int_t iVerbose = 1);
   
    /** Destructor **/
   virtual  ~R3BFi61DigitizerCal();
  ...
  protected:
    ...
    TClonesArray* fFi61Cals;
    TClonesArray* fFi61TriggerCals;
  ...
  Float_t  detector_width = fiber_nbr*fiber_thickness*(1+air_layer);  
    ...
    ClassDef(R3BFi61DigitizerCal, 1);
};
