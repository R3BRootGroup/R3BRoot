...
ClassImp(R3BFi61ContFact)

    static R3BFi61ContFact gR3BFi61ContFact;

R3BFi61ContFact::R3BFi61ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi61ContFact";
    fTitle = "Factory for parameter containers in libR3BdTof";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi61ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi61GeoPar", "Fi61 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi61ContFact::createContainer(FairContainer* c)
{
...
void R3BFi61ContFact::activateParIo(FairParIo* io)
{
