...
class R3BSTaRTra : public R3BDetector
{
  public:
     ...
     *@param rot     rotation
     */
    R3BSTaRTra(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BSTaRTra(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());
  ...
  private:
     ...
     **/
    R3BSTaRTraPoint* AddHit(Int_t trackID,
                            Int_t detID,
