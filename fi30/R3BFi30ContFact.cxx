...
ClassImp(R3BFi30ContFact)

    static R3BFi30ContFact gR3BFi30ContFact;

R3BFi30ContFact::R3BFi30ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi30ContFact";
    fTitle = "Factory for parameter containers in libR3BFi30";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi30ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi30GeoPar", "Fi30 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi30ContFact::createContainer(FairContainer* c)
{
...
void R3BFi30ContFact::activateParIo(FairParIo* io)
{
