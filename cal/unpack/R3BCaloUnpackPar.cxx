...
R3BCaloUnpackPar::R3BCaloUnpackPar(const char* name, const char* title, const char* context)
...
void R3BCaloUnpackPar::putParams(FairParamList* list)
{
  std::cout<<"-I- R3BCaloUnpackPar::putParams() called"<<std::endl;
...
Bool_t R3BCaloUnpackPar::getParams(FairParamList* list)
{
  std::cout<<"-I- R3BCaloUnpackPar::getParams() called"<<std::endl;
  if (!list) return kFALSE;
  std::cout<<"-I- R3BCaloUnpackPar::getParams() 1 ";
...
void R3BCaloUnpackPar::Print(Option_t* option) const
{
