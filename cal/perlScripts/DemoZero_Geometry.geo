 ...
 //Alveolus
	 ...
	 TGeoVolume *Alveolus_5 = gGeoManager->MakeTrd2("Alveolus_5", pCarbonFibreMedium,2.35,3.3460011312493,1.25,1.77436745203728,10); 
	 Alveolus_5->SetLineColor(kBlue); 

	 TGeoVolume *Alveolus_6 = gGeoManager->MakeTrd2("Alveolus_6", pCarbonFibreMedium,2.35,3.3460011312493,1.25,1.77436745203728,10); 
 ...
 //Crystals inside each alveoli 
	 ...
	 Alveolus_5->AddNode(CrystalWithWrapping_2A,1,new TGeoCombiTrans(1.37165024039048,0.721428083557922,-1.47,rotUni)); 
	 Alveolus_5->AddNode(CrystalWithWrapping_2A,2,new TGeoCombiTrans(-1.37165024039048,-0.721428083557922,-1.47,rotSymmetric)); 
	 Alveolus_5->AddNode(CrystalWithWrapping_2B,3,new TGeoCombiTrans(1.37157753336096,-0.721290166669044,-1.47,rotUni)); 
	 Alveolus_5->AddNode(CrystalWithWrapping_2B,4,new TGeoCombiTrans(-1.37157753336096,0.721290166669044,-1.47,rotSymmetric)); 
	 Alveolus_6->AddNode(CrystalWithWrapping_2A,1,new TGeoCombiTrans(1.37165024039048,0.721428083557922,-1.47,rotUni)); 
	 Alveolus_6->AddNode(CrystalWithWrapping_2A,2,new TGeoCombiTrans(-1.37165024039048,-0.721428083557922,-1.47,rotSymmetric)); 
	 Alveolus_6->AddNode(CrystalWithWrapping_2B,3,new TGeoCombiTrans(1.37157753336096,-0.721290166669044,-1.47,rotUni)); 
	 Alveolus_6->AddNode(CrystalWithWrapping_2B,4,new TGeoCombiTrans(-1.37157753336096,0.721290166669044,-1.47,rotSymmetric)); 
 ...
 //Positioning in space of alveoli 
	 ...
	 *transAlv_4_1 =  (*transAlv_4_1) * (*transDef); 
	 ...
	 TGeoRotation *rotAlv_5_0 = new TGeoRotation("rotAlv5_0",phiEuler,thetaEuler,psiEuler); 
	 TGeoCombiTrans* transAlv_5_0 = new TGeoCombiTrans(-0.030354222263823,30.8692311969528,30.7057173829619,rotAlv_5_0); 
	 *transAlv_5_0 =  (*transAlv_5_0) * (*transDef); 
	 pWorld->AddNode(Alveolus_5,0,transAlv_5_0); 

	 phiEuler = 180.*TMath::ATan2(-0.08301601643014699900,0.676111196877546)/TMath::Pi(); 
	 thetaEuler = 180.*TMath::ATan2(-0.08301601643014699900/TMath::Sin(TMath::Pi()*phiEuler/180.),0.7321079090358750800)/TMath::Pi(); 
	 psiEuler = 180.*TMath::ASin(-4.961077993545571400E-018/TMath::Sin(TMath::Pi()*thetaEuler/180.))/TMath::Pi(); 

	 TGeoRotation *rotAlv_5_1 = new TGeoRotation("rotAlv5_1",phiEuler,thetaEuler,psiEuler); 
	 TGeoCombiTrans* transAlv_5_1 = new TGeoCombiTrans(4.79903115708071,30.4939281828875,30.7057173829619,rotAlv_5_1); 
	 *transAlv_5_1 =  (*transAlv_5_1) * (*transDef); 
	 pWorld->AddNode(Alveolus_5,1,transAlv_5_1); 

	 phiEuler = 180.*TMath::ATan2(0.02217587015861272000,0.635033834631082)/TMath::Pi(); 
	 thetaEuler = 180.*TMath::ATan2(0.02217587015861272000/TMath::Sin(TMath::Pi()*phiEuler/180.),0.7721659534429447000)/TMath::Pi(); 
	 psiEuler = 180.*TMath::ASin(-1.751902534795422200E-018/TMath::Sin(TMath::Pi()*thetaEuler/180.))/TMath::Pi(); 

	 TGeoRotation *rotAlv_6_0 = new TGeoRotation("rotAlv6_0",phiEuler,thetaEuler,psiEuler); 
	 TGeoCombiTrans* transAlv_6_0 = new TGeoCombiTrans(-0.0283576326114219,30.8120563499644,27.3408312872623,rotAlv_6_0); 
	 *transAlv_6_0 =  (*transAlv_6_0) * (*transDef); 
	 pWorld->AddNode(Alveolus_6,0,transAlv_6_0); 

	 phiEuler = 180.*TMath::ATan2(-0.07743832980474656100,0.630684584733605)/TMath::Pi(); 
	 thetaEuler = 180.*TMath::ATan2(-0.07743832980474656100/TMath::Sin(TMath::Pi()*phiEuler/180.),0.7721659534429447000)/TMath::Pi(); 
	 psiEuler = 180.*TMath::ASin(-1.751902534795422200E-018/TMath::Sin(TMath::Pi()*thetaEuler/180.))/TMath::Pi(); 

	 TGeoRotation *rotAlv_6_1 = new TGeoRotation("rotAlv6_1",phiEuler,thetaEuler,psiEuler); 
	 TGeoCombiTrans* transAlv_6_1 = new TGeoCombiTrans(4.79205904879896,30.4371449177076,27.3408312872623,rotAlv_6_1); 
