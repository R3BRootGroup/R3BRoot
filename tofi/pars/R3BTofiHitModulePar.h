...
#ifndef R3BTOFIHITMODULEPAR_H
#define R3BTOFIHITMODULEPAR_H
 ...
 * storage of Tofi hit parameter
 */

class R3BTofiHitModulePar : public FairParGenericSet
{
  public:
    /**
     ...
     */
    R3BTofiHitModulePar(const char* name = "TofiHitModulePar",
                        const char* title = "TOFi hit calibration of a module",
     ...
     */
    virtual ~R3BTofiHitModulePar(void);
  ...
  private:
    ...
    ClassDef(R3BTofiHitModulePar, 1);
};
