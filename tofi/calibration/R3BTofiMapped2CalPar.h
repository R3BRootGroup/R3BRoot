...
// ----------------------------------------------------------------
// ----- Create time calib parameters for TOFI via FQT/Tamex -----
// -----      Adopted March 20121 from Tofd by M. Heil    -----
// ----------------------------------------------------------------

#ifndef R3BTOFIMAPPED2TCALPAR_H
#define R3BTOFIMAPPED2TCALPAR_H
 ...
 */
class R3BTofiMapped2CalPar : public FairTask
{
  ...
  public:
     ...
     */
    R3BTofiMapped2CalPar(const char*, Int_t = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofiMapped2CalPar();
  ...
  public:
    ClassDef(R3BTofiMapped2CalPar, 1)
};
