...
ClassImp(R3BFi10ContFact)

    static R3BFi10ContFact gR3BFi10ContFact;

R3BFi10ContFact::R3BFi10ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi10ContFact";
    fTitle = "Factory for parameter containers in libR3BFi10";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi10ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi10GeoPar", "Fi10 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi10ContFact::createContainer(FairContainer* c)
{
...
void R3BFi10ContFact::activateParIo(FairParIo* io)
{
