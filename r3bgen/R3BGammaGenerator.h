...
class R3BGammaGenerator : public FairGenerator
{
  public:
     ...
     *
     * @param idLevel Arbitrary ID for the level for later usage in SetBranchingRatio(), SetInitialLevel() or SetInitialLevelDistribution().
     ...
     * @param ratio Weight for this transition (the sum of all weights for each source level will be renormalized to 100%)
