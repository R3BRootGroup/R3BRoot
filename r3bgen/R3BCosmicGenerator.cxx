...
const std::vector<Double_t> _Distribution_EnergyValues      = {   .004,     .01,     .02,     .04,      .1,      .2,      .4,      1.,      2.,      4.,     10.,     20.,     40.,     100.}; 
const std::vector<Double_t> _Distribution_PropabilityValues = {5.89E-7, 1.05E-6, 1.63E-6, 2.34E-6, 3.13E-6, 3.89E-6, 4.18E-6, 2.02E-6, 9.11E-7, 3.81E-7, 1.11E-7, 3.00E-8, 3.40E-9, 9.01E-11}; 
...
R3BCosmicGenerator::R3BCosmicGenerator(const Int_t pdgid, const Int_t mult, const UInt_t seed)
  ...
  , fAngularDist_Rad({R3BDistribution1D::Function(Sin2, 0, TMath::Pi()),
                      R3BDistribution1D::Flat(0, 2*TMath::Pi())})
  , fRngGen(seed)
  , fPDGType(pdgid)
  , fMult(mult)
{
