// --------------------------------------------------------------------
// -----             R3BCaloEventDisplay source file              -----
// --------------------------------------------------------------------
...
// -----   Destructor   ----------------------------------------------------
R3BCaloEventDisplay::~R3BCaloEventDisplay() {}
// -------------------------------------------------------------------------

// -----   Public method Init   --------------------------------------------
InitStatus R3BCaloEventDisplay::Init()
{
...
//    Int_t ny = ay->GetNbins();
    ...
    for (Int_t i=0; i<crystalHits; i++) {
      ...
      if(kSimulation) {
        ...
        GetAngles(crystalHitSim->GetCrystalId(),&theta,&phi,&rho);
      } else {
        crystalHit  = (R3BCaloCrystalHit *) fCrystalHitCA->At(i);
        GetAngles(crystalHit->GetCrystalId(),&theta,&phi,&rho);
      }
...
// ---- Public method Reset   --------------------------------------------------
void R3BCaloEventDisplay::Reset()
{
...
void R3BCaloEventDisplay::Finish()
{
}


// -----   Private method CreateHistograms  -------------------------------------
void R3BCaloEventDisplay::CreateHistograms()
{
...
void R3BCaloEventDisplay::MakeSlots()
{
...
void R3BCaloEventDisplay::MakeViewerScene()
{
...
void R3BCaloEventDisplay::GetAngles(Int_t iD, Double_t* polar, Double_t* azimuthal, Double_t* rho)
{

	//The present scheme works only for 8.11 CALIFA geometry
