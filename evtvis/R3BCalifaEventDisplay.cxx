...
// -----   Default constructor   -------------------------------------------
R3BCalifaEventDisplay::R3BCalifaEventDisplay() : FairTask("R3BCalifaEventDisplay",0),
  fEventManager(NULL),
  fGeometryVersion(10),
  fDataHist(NULL),
  fCalo3d(NULL),
...
R3BCalifaEventDisplay::R3BCalifaEventDisplay(const char* name, Int_t iVerbose) : FairTask(name, iVerbose),
  fEventManager(NULL),
  fGeometryVersion(10),
  fDataHist(NULL),
  fCalo3d(NULL),
...
InitStatus R3BCalifaEventDisplay::ReInit()
{
  return kSUCCESS;
}
...
void R3BCalifaEventDisplay::SelectGeometryVersion(Int_t version)
{
