...
// -----   Destructor   ----------------------------------------------------
R3BCaloHitEventDisplay::~R3BCaloHitEventDisplay() {}
// -------------------------------------------------------------------------

// -----   Public method Init   --------------------------------------------
InitStatus R3BCaloHitEventDisplay::Init()
{

  FairRootManager* ioManager = FairRootManager::Instance();
  if ( !ioManager ) Fatal("Init", "No FairRootManager");
  if( !ioManager->GetObject("CaloHitSim") ) {
     fCaloHitCA = (TClonesArray*) ioManager->GetObject("CaloHit");
  } else {
     fCaloHitCA = (TClonesArray*) ioManager->GetObject("CaloHitSim");
     kSimulation = true;
  }
...
InitStatus R3BCaloHitEventDisplay::ReInit()
{
...
//    Int_t ny = ay->GetNbins();
    ...
    for (Int_t i=0; i<caloHits; i++) {
      ...
      if(kSimulation) {
        caloHitSim = (R3BCaloHitSim *) fCaloHitCA->At(i);
        theta = caloHitSim->GetTheta();
        phi   = caloHitSim->GetPhi();
      } else {
        caloHit  = (R3BCaloHit *) fCaloHitCA->At(i);
...
// ---- Public method Reset   --------------------------------------------------
void R3BCaloHitEventDisplay::Reset()
{
...
void R3BCaloHitEventDisplay::Finish()
{
}


// -----   Private method CreateHistograms  -------------------------------------
void R3BCaloHitEventDisplay::CreateHistograms()
{
...
void R3BCaloHitEventDisplay::MakeSlots()
{
...
void R3BCaloHitEventDisplay::MakeViewerScene()
{
...
ClassImp(R3BCaloHitEventDisplay)
