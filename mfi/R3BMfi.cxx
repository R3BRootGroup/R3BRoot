...
R3BMfi::R3BMfi(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot)
    : R3BMfi(geoFile, { trans, rot })
{
}

R3BMfi::R3BMfi(const TString& geoFile, const TGeoCombiTrans& combi)
    : R3BDetector("R3BMfi", kMFI, geoFile, combi)
...
void R3BMfi::Register() { FairRootManager::Instance()->Register("MFIPoint", GetName(), fMfiCollection, kTRUE); }
// ----------------------------------------------------------------------------
...
R3BMfiPoint* R3BMfi::AddHit(Int_t trackID,
                            Int_t detID,
                            Int_t plane,
                            TVector3 posIn,
                            TVector3 posOut,
