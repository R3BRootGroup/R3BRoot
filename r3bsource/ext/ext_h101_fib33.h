...
#define EXT_STR_h101_FIBEE_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ok = 1; \
  /* RAW */ \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLCMI,                    UINT32,\
                    "FIBEE_TBLCMI",                    "FIBEE_TBLCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLCME,                    UINT32,\
                    "FIBEE_TBLCME",                    "FIBEE_TBLCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLC,                      UINT32,\
                    "FIBEE_TBLC",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLCv,                     UINT32,\
                    "FIBEE_TBLCv",                     "FIBEE_TBLC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLFM,                     UINT32,\
                    "FIBEE_TBLFM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLFMI,                    UINT32,\
                    "FIBEE_TBLFMI",                    "FIBEE_TBLFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLFME,                    UINT32,\
                    "FIBEE_TBLFME",                    "FIBEE_TBLFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLF,                      UINT32,\
                    "FIBEE_TBLF",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBLFv,                     UINT32,\
                    "FIBEE_TBLFv",                     "FIBEE_TBLF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTCM,                     UINT32,\
                    "FIBEE_TBTCM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTCMI,                    UINT32,\
                    "FIBEE_TBTCMI",                    "FIBEE_TBTCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTCME,                    UINT32,\
                    "FIBEE_TBTCME",                    "FIBEE_TBTCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTC,                      UINT32,\
                    "FIBEE_TBTC",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTCv,                     UINT32,\
                    "FIBEE_TBTCv",                     "FIBEE_TBTC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTFM,                     UINT32,\
                    "FIBEE_TBTFM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTFMI,                    UINT32,\
                    "FIBEE_TBTFMI",                    "FIBEE_TBTFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTFME,                    UINT32,\
                    "FIBEE_TBTFME",                    "FIBEE_TBTFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTF,                      UINT32,\
                    "FIBEE_TBTF",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TBTFv,                     UINT32,\
                    "FIBEE_TBTFv",                     "FIBEE_TBTF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLCM,                     UINT32,\
                    "FIBEE_TTLCM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLCMI,                    UINT32,\
                    "FIBEE_TTLCMI",                    "FIBEE_TTLCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLCME,                    UINT32,\
                    "FIBEE_TTLCME",                    "FIBEE_TTLCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLC,                      UINT32,\
                    "FIBEE_TTLC",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLCv,                     UINT32,\
                    "FIBEE_TTLCv",                     "FIBEE_TTLC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLFM,                     UINT32,\
                    "FIBEE_TTLFM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLFMI,                    UINT32,\
                    "FIBEE_TTLFMI",                    "FIBEE_TTLFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLFME,                    UINT32,\
                    "FIBEE_TTLFME",                    "FIBEE_TTLFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLF,                      UINT32,\
                    "FIBEE_TTLF",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTLFv,                     UINT32,\
                    "FIBEE_TTLFv",                     "FIBEE_TTLF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTCM,                     UINT32,\
                    "FIBEE_TTTCM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTCMI,                    UINT32,\
                    "FIBEE_TTTCMI",                    "FIBEE_TTTCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTCME,                    UINT32,\
                    "FIBEE_TTTCME",                    "FIBEE_TTTCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTC,                      UINT32,\
                    "FIBEE_TTTC",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTCv,                     UINT32,\
                    "FIBEE_TTTCv",                     "FIBEE_TTTC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTFM,                     UINT32,\
                    "FIBEE_TTTFM",512); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTFMI,                    UINT32,\
                    "FIBEE_TTTFMI",                    "FIBEE_TTTFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTFME,                    UINT32,\
                    "FIBEE_TTTFME",                    "FIBEE_TTTFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTF,                      UINT32,\
                    "FIBEE_TTTF",32768); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TTTFv,                     UINT32,\
                    "FIBEE_TTTFv",                     "FIBEE_TTTF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGCM,                    UINT32,\
                    "FIBEE_TRIGCM",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGCMI,                   UINT32,\
                    "FIBEE_TRIGCMI",                   "FIBEE_TRIGCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGCME,                   UINT32,\
                    "FIBEE_TRIGCME",                   "FIBEE_TRIGCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGC,                     UINT32,\
                    "FIBEE_TRIGC",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGCv,                    UINT32,\
                    "FIBEE_TRIGCv",                    "FIBEE_TRIGC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGFM,                    UINT32,\
                    "FIBEE_TRIGFM",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGFMI,                   UINT32,\
                    "FIBEE_TRIGFMI",                   "FIBEE_TRIGFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGFME,                   UINT32,\
                    "FIBEE_TRIGFME",                   "FIBEE_TRIGFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGF,                     UINT32,\
                    "FIBEE_TRIGF",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBEE_TRIGFv,                    UINT32,\
                    "FIBEE_TRIGFv",                    "FIBEE_TRIGF"); \
  \
} while (0);
