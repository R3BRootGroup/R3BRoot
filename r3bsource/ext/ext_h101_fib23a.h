...
#define EXT_STR_h101_FIBZEA_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ok = 1; \
  /* RAW */ \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLCMI,                   UINT32,\
                    "FIBZEA_TBLCMI",                   "FIBZEA_TBLCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLCME,                   UINT32,\
                    "FIBZEA_TBLCME",                   "FIBZEA_TBLCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLC,                     UINT32,\
                    "FIBZEA_TBLC",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLCv,                    UINT32,\
                    "FIBZEA_TBLCv",                    "FIBZEA_TBLC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLFM,                    UINT32,\
                    "FIBZEA_TBLFM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLFMI,                   UINT32,\
                    "FIBZEA_TBLFMI",                   "FIBZEA_TBLFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLFME,                   UINT32,\
                    "FIBZEA_TBLFME",                   "FIBZEA_TBLFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLF,                     UINT32,\
                    "FIBZEA_TBLF",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBLFv,                    UINT32,\
                    "FIBZEA_TBLFv",                    "FIBZEA_TBLF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTCM,                    UINT32,\
                    "FIBZEA_TBTCM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTCMI,                   UINT32,\
                    "FIBZEA_TBTCMI",                   "FIBZEA_TBTCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTCME,                   UINT32,\
                    "FIBZEA_TBTCME",                   "FIBZEA_TBTCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTC,                     UINT32,\
                    "FIBZEA_TBTC",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTCv,                    UINT32,\
                    "FIBZEA_TBTCv",                    "FIBZEA_TBTC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTFM,                    UINT32,\
                    "FIBZEA_TBTFM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTFMI,                   UINT32,\
                    "FIBZEA_TBTFMI",                   "FIBZEA_TBTFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTFME,                   UINT32,\
                    "FIBZEA_TBTFME",                   "FIBZEA_TBTFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTF,                     UINT32,\
                    "FIBZEA_TBTF",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TBTFv,                    UINT32,\
                    "FIBZEA_TBTFv",                    "FIBZEA_TBTF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLCM,                    UINT32,\
                    "FIBZEA_TTLCM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLCMI,                   UINT32,\
                    "FIBZEA_TTLCMI",                   "FIBZEA_TTLCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLCME,                   UINT32,\
                    "FIBZEA_TTLCME",                   "FIBZEA_TTLCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLC,                     UINT32,\
                    "FIBZEA_TTLC",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLCv,                    UINT32,\
                    "FIBZEA_TTLCv",                    "FIBZEA_TTLC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLFM,                    UINT32,\
                    "FIBZEA_TTLFM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLFMI,                   UINT32,\
                    "FIBZEA_TTLFMI",                   "FIBZEA_TTLFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLFME,                   UINT32,\
                    "FIBZEA_TTLFME",                   "FIBZEA_TTLFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLF,                     UINT32,\
                    "FIBZEA_TTLF",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTLFv,                    UINT32,\
                    "FIBZEA_TTLFv",                    "FIBZEA_TTLF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTCM,                    UINT32,\
                    "FIBZEA_TTTCM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTCMI,                   UINT32,\
                    "FIBZEA_TTTCMI",                   "FIBZEA_TTTCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTCME,                   UINT32,\
                    "FIBZEA_TTTCME",                   "FIBZEA_TTTCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTC,                     UINT32,\
                    "FIBZEA_TTTC",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTCv,                    UINT32,\
                    "FIBZEA_TTTCv",                    "FIBZEA_TTTC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTFM,                    UINT32,\
                    "FIBZEA_TTTFM",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTFMI,                   UINT32,\
                    "FIBZEA_TTTFMI",                   "FIBZEA_TTTFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTFME,                   UINT32,\
                    "FIBZEA_TTTFME",                   "FIBZEA_TTTFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTF,                     UINT32,\
                    "FIBZEA_TTTF",16384); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TTTFv,                    UINT32,\
                    "FIBZEA_TTTFv",                    "FIBZEA_TTTF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGCM,                   UINT32,\
                    "FIBZEA_TRIGCM",4); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGCMI,                  UINT32,\
                    "FIBZEA_TRIGCMI",                  "FIBZEA_TRIGCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGCME,                  UINT32,\
                    "FIBZEA_TRIGCME",                  "FIBZEA_TRIGCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGC,                    UINT32,\
                    "FIBZEA_TRIGC",4); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGCv,                   UINT32,\
                    "FIBZEA_TRIGCv",                   "FIBZEA_TRIGC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGFM,                   UINT32,\
                    "FIBZEA_TRIGFM",4); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGFMI,                  UINT32,\
                    "FIBZEA_TRIGFMI",                  "FIBZEA_TRIGFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGFME,                  UINT32,\
                    "FIBZEA_TRIGFME",                  "FIBZEA_TRIGFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGF,                    UINT32,\
                    "FIBZEA_TRIGF",4); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     FIBZEA_TRIGFv,                   UINT32,\
                    "FIBZEA_TRIGFv",                   "FIBZEA_TRIGF"); \
  \
} while (0);
