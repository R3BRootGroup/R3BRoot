...
typedef struct EXT_STR_h101_WRNEULAND_t
{
    /* RAW */
...
typedef struct EXT_STR_h101_WRNEULAND_onion_t
{
    /* RAW */
    uint32_t NN_WR_ID;
    uint32_t NN_WR_T[4];
...
typedef struct EXT_STR_h101_WRNEULAND_layout_t
{
    uint32_t _magic;
    uint32_t _size_info;
...
} EXT_STR_h101_WRNEULAND_layout;

#define EXT_STR_h101_WRNEULAND_LAYOUT_INIT                                     \
    { 0x57e65c96,                                                              \
      sizeof(EXT_STR_h101_WRNEULAND_layout),                                   \
      sizeof(EXT_STR_h101_WRNEULAND),                                          \
      sizeof(EXT_STR_h101_WRNEULAND_onion),                                    \
      7,                                                                       \
      1,                                                                       \
      {                                                                        \
          { 0, sizeof(EXT_STR_h101_WRNEULAND), 0x3d016f20, "h101_WRNEULAND" }, \
      },                                                                       \
      {                                                                        \
          0x40000000,                                                          \
          0x40000004,                                                          \
...
#endif /*__GUARD_H101_WRNEULAND_EXT_H101_WRNEULAND_H__*/
