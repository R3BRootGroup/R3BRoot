...
Bool_t R3BTrloiiScalerReader::Read()
{
    ...
    {
        /*if(fData->TRLO[0].TRLOBDT_MAIN[ch]) {
            std::cout<<"RAW: "<<fNEvent<<", "<<ch+1<<", "<<fData->TRLO[0].TRLORAW_MAIN[ch]<<std::endl;
            std::cout<<"BDT: "<<fNEvent<<", "<<ch+1<<", "<<fData->TRLO[0].TRLOBDT_MAIN[ch]<<std::endl;
            std::cout<<"ADT: "<<fNEvent<<", "<<ch+1<<", "<<fData->TRLO[0].TRLOADT_MAIN[ch]<<std::endl;
            std::cout<<"ARD: "<<fNEvent<<", "<<ch+1<<", "<<fData->TRLO[0].TRLOARD_MAIN[ch]<<std::endl;
        }*/
