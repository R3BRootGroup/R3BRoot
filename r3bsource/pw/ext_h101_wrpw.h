...
#ifndef __GUARD_H101_WRPW_EXT_H101_WRPW_H__
#define __GUARD_H101_WRPW_EXT_H101_WRPW_H__
...
typedef struct EXT_STR_h101_WRPW_t
{
    /* RAW */
...
typedef struct EXT_STR_h101_WRPW_onion_t
{
    /* RAW */
    uint32_t TIMESTAMP_PW_ID;
    uint32_t TIMESTAMP_PW_WR_T[4];

} EXT_STR_h101_WRPW_onion;

/*******************************************************/

#define EXT_STR_h101_WRPW_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                               \
    do                                                                                                                 \
    {                                                                                                                  \
        ok = 1;                                                                                                        \
        /* RAW */                                                                                                      \
...
#endif /*__GUARD_H101_WRPW_EXT_H101_WRPW_H__*/
