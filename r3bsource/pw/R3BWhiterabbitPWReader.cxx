...
R3BWhiterabbitPWReader::~R3BWhiterabbitPWReader()
{
    if (fArray)
    {
        delete fArray;
...
Bool_t R3BWhiterabbitPWReader::Init(ext_data_struct_info* a_struct_info)
{
    Int_t ok;
    R3BLOG(info, "");
    EXT_STR_h101_WRPW_ITEMS_INFO(ok, *a_struct_info, fOffset, EXT_STR_h101_WRPW, 0);
    ...
    FairRootManager::Instance()->Register("WRPWData", "WRPW", fArray, !fOnline);
    Reset();
