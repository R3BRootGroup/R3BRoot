...
typedef struct EXT_STR_h101_SCI2_t
{
  ...
  uint32_t SCITWO_VTFME[8 EXT_STRUCT_CTRL(SCITWO_VTFM)] /* [1,256] */;
  uint32_t SCITWO_VTF /* [0,256] */;
  uint32_t SCITWO_VTFv[256 EXT_STRUCT_CTRL(SCITWO_VTF)] /* [0,65535] */;
  uint32_t SCITWO_VTCM /* [1,8] */;
  uint32_t SCITWO_VTCMI[8 EXT_STRUCT_CTRL(SCITWO_VTCM)] /* [1,8] */;
  uint32_t SCITWO_VTCME[8 EXT_STRUCT_CTRL(SCITWO_VTCM)] /* [1,256] */;
  uint32_t SCITWO_VTC /* [0,256] */;
  uint32_t SCITWO_VTCv[256 EXT_STRUCT_CTRL(SCITWO_VTC)] /* [0,65535] */;
...
typedef struct EXT_STR_h101_SCI2_onion_t
{
  ...
  uint32_t SCITWO_VTF;
  uint32_t SCITWO_VTFv[256 /* SCITWO_VTF */];
  uint32_t SCITWO_VTCM;
  uint32_t SCITWO_VTCMI[8 /* SCITWO_VTCM */];
  uint32_t SCITWO_VTCME[8 /* SCITWO_VTCM */];
  uint32_t SCITWO_VTC;
  uint32_t SCITWO_VTCv[256 /* SCITWO_VTC */];

} EXT_STR_h101_SCI2_onion;

/*******************************************************/

#define EXT_STR_h101_SCI2_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ok = 1; \
  /* RAW */ \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTFMI,                    UINT32,\
                    "SCITWO_VTFMI",                    "SCITWO_VTFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTFME,                    UINT32,\
                    "SCITWO_VTFME",                    "SCITWO_VTFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTF,                      UINT32,\
                    "SCITWO_VTF",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTFv,                     UINT32,\
                    "SCITWO_VTFv",                     "SCITWO_VTF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTCM,                     UINT32,\
                    "SCITWO_VTCM",8); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTCMI,                    UINT32,\
                    "SCITWO_VTCMI",                    "SCITWO_VTCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTCME,                    UINT32,\
                    "SCITWO_VTCME",                    "SCITWO_VTCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTC,                      UINT32,\
                    "SCITWO_VTC",256); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SCITWO_VTCv,                     UINT32,\
                    "SCITWO_VTCv",                     "SCITWO_VTC"); \
  \
} while (0);
...
#define EXT_STR_h101_SCI2_LAYOUT_INIT { \
  ...
  { \
    ...
    0x40000048, 0xc000004c, 0x00000100, 0x00000001, \
    ...
    0xc0000450, 0x00000008, 0x00000002, 0x40000454, \
    0x40000474, 0x40000458, 0x40000478, 0x4000045c, \
    0x4000047c, 0x40000460, 0x40000480, 0x40000464, \
    0x40000484, 0x40000468, 0x40000488, 0x4000046c, \
    0x4000048c, 0x40000470, 0x40000490, 0xc0000494, \
    0x00000100, 0x00000001, 0x40000498, 0x4000049c, \
