...
#define EXT_STR_h101_FRSSCI_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTFM,                     UINT32,\
                    "FRSSCI1VTFM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTFMI,                    UINT32,\
                    "FRSSCI1VTFMI",                    "FRSSCI1VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTFME,                    UINT32,\
                    "FRSSCI1VTFME",                    "FRSSCI1VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTF,                      UINT32,\
                    "FRSSCI1VTF",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTFv,                     UINT32,\
                    "FRSSCI1VTFv",                     "FRSSCI1VTF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTCM,                     UINT32,\
                    "FRSSCI1VTCM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTCMI,                    UINT32,\
                    "FRSSCI1VTCMI",                    "FRSSCI1VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTCME,                    UINT32,\
                    "FRSSCI1VTCME",                    "FRSSCI1VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTC,                      UINT32,\
                    "FRSSCI1VTC",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI1VTCv,                     UINT32,\
                    "FRSSCI1VTCv",                     "FRSSCI1VTC",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTFM,                     UINT32,\
                    "FRSSCI2VTFM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTFMI,                    UINT32,\
                    "FRSSCI2VTFMI",                    "FRSSCI2VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTFME,                    UINT32,\
                    "FRSSCI2VTFME",                    "FRSSCI2VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTF,                      UINT32,\
                    "FRSSCI2VTF",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTFv,                     UINT32,\
                    "FRSSCI2VTFv",                     "FRSSCI2VTF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTCM,                     UINT32,\
                    "FRSSCI2VTCM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTCMI,                    UINT32,\
                    "FRSSCI2VTCMI",                    "FRSSCI2VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTCME,                    UINT32,\
                    "FRSSCI2VTCME",                    "FRSSCI2VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTC,                      UINT32,\
                    "FRSSCI2VTC",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI2VTCv,                     UINT32,\
                    "FRSSCI2VTCv",                     "FRSSCI2VTC",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTFM,                     UINT32,\
                    "FRSSCI3VTFM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTFMI,                    UINT32,\
                    "FRSSCI3VTFMI",                    "FRSSCI3VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTFME,                    UINT32,\
                    "FRSSCI3VTFME",                    "FRSSCI3VTFM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTF,                      UINT32,\
                    "FRSSCI3VTF",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTFv,                     UINT32,\
                    "FRSSCI3VTFv",                     "FRSSCI3VTF",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTCM,                     UINT32,\
                    "FRSSCI3VTCM",4,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTCMI,                    UINT32,\
                    "FRSSCI3VTCMI",                    "FRSSCI3VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTCME,                    UINT32,\
                    "FRSSCI3VTCME",                    "FRSSCI3VTCM",0/*flags*/); \
  EXT_STR_ITEM_INFO2_LIM(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTC,                      UINT32,\
                    "FRSSCI3VTC",512,0/*flags*/); \
  EXT_STR_ITEM_INFO2_ZZP(ok,si,offset,struct_t,printerr,\
                     FRSSCI3VTCv,                     UINT32,\
                    "FRSSCI3VTCv",                     "FRSSCI3VTC",0/*flags*/); \
  \
} while (0);
