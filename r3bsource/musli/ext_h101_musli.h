...
#define EXT_STR_h101_MUSLI_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ok = 1; \
  /* RAW */ \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TREFMI,                    UINT32,\
                    "MUSLI_TREFMI",                    "MUSLI_TREFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TREFME,                    UINT32,\
                    "MUSLI_TREFME",                    "MUSLI_TREFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     MUSLI_TREF,                      UINT32,\
                    "MUSLI_TREF",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TREFv,                     UINT32,\
                    "MUSLI_TREFv",                     "MUSLI_TREF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     MUSLI_TTRIGM,                    UINT32,\
                    "MUSLI_TTRIGM",1); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TTRIGMI,                   UINT32,\
                    "MUSLI_TTRIGMI",                   "MUSLI_TTRIGM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TTRIGME,                   UINT32,\
                    "MUSLI_TTRIGME",                   "MUSLI_TTRIGM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     MUSLI_TTRIG,                     UINT32,\
                    "MUSLI_TTRIG",100); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     MUSLI_TTRIGv,                    UINT32,\
                    "MUSLI_TTRIGv",                    "MUSLI_TTRIG"); \
  \
} while (0);
