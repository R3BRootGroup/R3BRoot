...
typedef struct EXT_STR_h101_FOOT_t
{
    ...
    uint32_t FOOT17 /* [0,640] */;
    uint32_t FOOT17I[640 EXT_STRUCT_CTRL(FOOT17)] /* [1,640] */;
    uint32_t FOOT17E[640 EXT_STRUCT_CTRL(FOOT17)] /* [0,65535] */;
    uint32_t FOOT18 /* [0,640] */;
    uint32_t FOOT18I[640 EXT_STRUCT_CTRL(FOOT18)] /* [1,640] */;
    uint32_t FOOT18E[640 EXT_STRUCT_CTRL(FOOT18)] /* [0,65535] */;
    uint32_t FOOT19 /* [0,640] */;
    uint32_t FOOT19I[640 EXT_STRUCT_CTRL(FOOT19)] /* [1,640] */;
    uint32_t FOOT19E[640 EXT_STRUCT_CTRL(FOOT19)] /* [0,65535] */;
    uint32_t FOOT20 /* [0,640] */;
    uint32_t FOOT20I[640 EXT_STRUCT_CTRL(FOOT20)] /* [1,640] */;
    uint32_t FOOT20E[640 EXT_STRUCT_CTRL(FOOT20)] /* [0,65535] */;
...
#define EXT_STR_h101_FOOT_ITEMS_INFO(ok, si, offset, struct_t, printerr)                                 \
    ...
    {                                                                                                    \
        ...
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, FOOT17, UINT32, "FOOT17", 640);        \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT17I, UINT32, "FOOT17I", "FOOT17"); \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT17E, UINT32, "FOOT17E", "FOOT17"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, FOOT18, UINT32, "FOOT18", 640);        \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT18I, UINT32, "FOOT18I", "FOOT18"); \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT18E, UINT32, "FOOT18E", "FOOT18"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, FOOT19, UINT32, "FOOT19", 640);        \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT19I, UINT32, "FOOT19I", "FOOT19"); \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT19E, UINT32, "FOOT19E", "FOOT19"); \
        EXT_STR_ITEM_INFO_LIM(ok, si, offset, struct_t, printerr, FOOT20, UINT32, "FOOT20", 640);        \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT20I, UINT32, "FOOT20I", "FOOT20"); \
        EXT_STR_ITEM_INFO_ZZP(ok, si, offset, struct_t, printerr, FOOT20E, UINT32, "FOOT20E", "FOOT20"); \
                                                                                                         \
    } while (0);
