...
class R3BMwpc0 : public R3BDetector
{
  public:
    /** Default constructor **/
    R3BMwpc0();
     ...
     *@param rot     rotation
     */
    R3BMwpc0(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BMwpc0(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());
...
inline void R3BMwpc0::ResetParameters()
{
