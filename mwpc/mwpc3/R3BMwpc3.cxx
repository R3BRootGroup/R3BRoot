...
R3BMwpc3::R3BMwpc3(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot)
    : R3BMwpc3(geoFile, { trans, rot })
{
}

R3BMwpc3::R3BMwpc3(const TString& geoFile, const TGeoCombiTrans& combi)
    : R3BDetector("R3BMwpc3", kSOFMWPC3, geoFile, combi)
...
Bool_t R3BMwpc3::ProcessHits(FairVolume* vol)
{
...
void R3BMwpc3::Register() { FairRootManager::Instance()->Register("Mwpc3Point", GetName(), fSofMWPCCollection, kTRUE); }
// ----------------------------------------------------------------------------

// -----   Public method GetCollection   --------------------------------------
TClonesArray* R3BMwpc3::GetCollection(Int_t iColl) const
{
    if (iColl == 0)
...
// -----   Public method Print   ----------------------------------------------
void R3BMwpc3::Print(Option_t* option) const
{
    Int_t nHits = fSofMWPCCollection->GetEntriesFast();
    LOG(info) << "R3BMwpc3: " << nHits << " points registered in this event";
}
// ----------------------------------------------------------------------------
...
void R3BMwpc3::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    Int_t nEntries = cl1->GetEntriesFast();
    LOG(info) << "R3BMwpc3: " << nEntries << " entries to add";
    ...
    LOG(info) << "R3BMwpc3: " << cl2->GetEntriesFast() << " merged entries";
}

// -----   Private method AddPoint   --------------------------------------------
R3BMwpcPoint* R3BMwpc3::AddPoint(Int_t trackID,
                                 Int_t detID,
                                 Int_t detCopyID,
                                 TVector3 posIn,
                                 TVector3 posOut,
