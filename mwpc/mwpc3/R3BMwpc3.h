...
class R3BMwpc3 : public R3BDetector
{
  public:
    /** Default constructor **/
    R3BMwpc3();
     ...
     *@param rot     rotation
     */
    R3BMwpc3(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BMwpc3(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());
...
inline void R3BMwpc3::ResetParameters()
{
