...
#ifndef R3BMwpc3MAPPED2CALPAR_H
#define R3BMwpc3MAPPED2CALPAR_H 1
...
class R3BMwpc3Mapped2CalPar : public FairTask
{
  public:
    /* Default Constructor */
    R3BMwpc3Mapped2CalPar();

    /* Standard Constructor*/
    R3BMwpc3Mapped2CalPar(const char* name, Int_t iVerbose = 1);

    /* Destructor */
    virtual ~R3BMwpc3Mapped2CalPar();
    ...
    ClassDef(R3BMwpc3Mapped2CalPar, 0);
  ...
  protected:
    ...
    R3BMwpc3CalPar* fPad_Par;        /*  Parameter container */
