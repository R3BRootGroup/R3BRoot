...
class R3BMwpc2 : public R3BDetector
{
  public:
     ...
     *@param rot     rotation
     */
    R3BMwpc2(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BMwpc2(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());
