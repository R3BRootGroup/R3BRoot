...
ClassImp(R3BFi8ContFact)

    static R3BFi8ContFact gR3BFi8ContFact;

R3BFi8ContFact::R3BFi8ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi8ContFact";
    fTitle = "Factory for parameter containers in libR3BFi8";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi8ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi8GeoPar", "Fi8 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi8ContFact::createContainer(FairContainer* c)
{
...
void R3BFi8ContFact::activateParIo(FairParIo* io)
{
