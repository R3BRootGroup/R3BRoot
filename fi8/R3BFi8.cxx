...
void R3BFi8::Initialize()
{
    ...
    LOG(INFO) << "R3BFi8: initialisation" << FairLogger::endl;
    LOG(DEBUG) << "R3BFi8: Vol. (McId) " << gMC->VolId("FI81Log") << FairLogger::endl;
}

void R3BFi8::SetSpecialPhysicsCuts()
{
    LOG(INFO) << "-I- R3BFi8: Adding customized Physics cut ... " << FairLogger::endl;
...
void R3BFi8::Print(Option_t* option) const
{
    ...
    LOG(INFO) << "R3BFi8: " << nHits << " points registered in this event" << FairLogger::endl;
}
// ----------------------------------------------------------------------------
...
void R3BFi8::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    LOG(INFO) << "R3BFi8: " << nEntries << " entries to add" << FairLogger::endl;
    ...
    LOG(INFO) << "R3BFi8: " << cl2->GetEntriesFast() << " merged entries" << FairLogger::endl;
}
