...
ClassImp(R3BFi7ContFact)

    static R3BFi7ContFact gR3BFi7ContFact;

R3BFi7ContFact::R3BFi7ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi7ContFact";
    fTitle = "Factory for parameter containers in libR3BFi7";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi7ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi7GeoPar", "Fi7 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi7ContFact::createContainer(FairContainer* c)
{
...
void R3BFi7ContFact::activateParIo(FairParIo* io)
{
