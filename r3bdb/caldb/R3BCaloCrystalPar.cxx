...
Bool_t R3BCaloCrystalPar::getParams(FairParamList* list)
{
  ...
  Text_t idamcrysaux[80];
  if (!list->fill("CrystalPar_IdAmcrys", idamcrysaux, 80)) { return kFALSE; }
  fIdAmcrys = idamcrysaux;
...
void R3BCaloCrystalPar::clear()
{
  ...
  fIdAmcrys=fEnergySource=fOrigin=fLocation=fObservation="";
