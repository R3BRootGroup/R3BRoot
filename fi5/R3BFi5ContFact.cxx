...
ClassImp(R3BFi5ContFact)

    static R3BFi5ContFact gR3BFi5ContFact;

R3BFi5ContFact::R3BFi5ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi5ContFact";
    fTitle = "Factory for parameter containers in libR3BFi5";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi5ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi5GeoPar", "Fi5 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi5ContFact::createContainer(FairContainer* c)
{
...
void R3BFi5ContFact::activateParIo(FairParIo* io)
{
