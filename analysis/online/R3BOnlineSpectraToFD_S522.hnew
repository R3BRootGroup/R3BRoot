...
#ifndef R3BOnlineSpectraToFD_S522_H
#define R3BOnlineSpectraToFD_S522_H 1

#define N_PLANE_MAX_TOFD_S522 4
#define N_PADDLE_MAX_TOFD_S522 44
...
class R3BOnlineSpectraToFD_S522 : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    R3BOnlineSpectraToFD_S522(const char* name, Int_t iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BOnlineSpectraToFD_S522();
  ...
  private:
    ...
    TH1F* fh_tofd_channels[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_multihit[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_TotPm[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_dt[N_PLANE_MAX_TOFD_S522 - 1];
    TH1F* fh_TimePreviousEvent;
    TH2F* fh_tofd_multihit_coinc[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_TotPm_coinc[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_num_side[N_PLANE_MAX_TOFD_S522];
    TH1F* fh_tofd_bars[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_Tot_hit[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_time_hit[N_PLANE_MAX_TOFD_S522];
    TH1F* fh_tofd_multihit_hit[N_PLANE_MAX_TOFD_S522];
    TH2F* fh_tofd_dt_hit[N_PLANE_MAX_TOFD_S522 - 1];

  public:
    ClassDef(R3BOnlineSpectraToFD_S522, 1)
};
