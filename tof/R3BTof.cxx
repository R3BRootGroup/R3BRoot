...
{
  LOG(INFO) << "R3BTof: Adding customized Physics cut ... " << FairLogger::endl;
  ...
  if (gGeoManager) {
    ...
    if ( pSi ) {
      ...
      LOG(INFO) << "R3bTof Scintillator Medium Id " << pSi->GetId()
	    << " Energy Cut-Off : " << cutE
	    << FairLogger::endl;
			    ...
			    Double_t length, Double_t eLoss)
{
  ...
  if (fVerboseLevel>1)
    LOG(INFO) << "R3BTof: Adding Point at (" << posIn.X() << ", " << posIn.Y()
