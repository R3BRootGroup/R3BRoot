    ...
    , fClockFreq(1. / VFTX_CLOCK_MHZ * 1000.)
{
    ...
    for (Int_t i = 0; i < N_PLANE_TOFD_MAX; i++)
    {
        for (Int_t j = 0; j < N_PADDLE_TOFD_MAX; j++)
        {
            fhPos[i][j] = NULL;
            fhTotPm1[i][j] = NULL;		
	    fhTotPm2[i][j] = NULL;
...
void R3BTofdCal2Hit::Exec(Option_t* option)
{
      ...
      Double_t t[N_PLANE_TOFD_MAX+1][N_PADDLE_TOFD_MAX+1],x[N_PLANE_TOFD_MAX+1][N_PADDLE_TOFD_MAX+1];
      Double_t y[N_PLANE_TOFD_MAX+1][N_PADDLE_TOFD_MAX+1],Q[N_PLANE_TOFD_MAX+1][N_PADDLE_TOFD_MAX+1];
      Double_t tof[N_PLANE_TOFD_MAX+1][N_PADDLE_TOFD_MAX+1];
