...
#ifndef R3BTOFDHISTO2HITPAR_H
#define R3BTOFDHISTO2HITPAR_H
...
#endif
class R3BTofdHisto2HitPar : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    R3BTofdHisto2HitPar(const char* name, Int_t iVerbose = 1);
    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BTofdHisto2HitPar();
    /**
     ...
     */
    virtual void smiley(TH2F* histo, Double_t min, Double_t max, Double_t*, Int_t p, Int_t b);
  ...
  public:
    ClassDef(R3BTofdHisto2HitPar, 1)
};
