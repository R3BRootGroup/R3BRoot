...
class R3BTwimCal2Hit : public FairTask
{
  ...
  private:
    ...
    R3BTwimHitData* AddHitData(UShort_t secID, Double_t theta, Double_t charge_z);
    R3BTwimHitData* AddHitData(UShort_t secID, Double_t theta, Double_t charge_z, Double_t ene_ave);
