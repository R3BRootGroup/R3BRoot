...
void R3BFi3a::Initialize()
{
    ...
    LOG(INFO) << "R3BFi3a: initialisation" << FairLogger::endl;
    LOG(DEBUG) << "R3BFi3a: Vol. (McId) " << gMC->VolId("FI3a1Log") << FairLogger::endl;
}

void R3BFi3a::SetSpecialPhysicsCuts()
{
    LOG(INFO) << "-I- R3BFi3a: Adding customized Physics cut ... " << FairLogger::endl;
...
void R3BFi3a::Print(Option_t* option) const
{
    ...
    LOG(INFO) << "R3BFi3a: " << nHits << " points registered in this event" << FairLogger::endl;
}
// ----------------------------------------------------------------------------
...
void R3BFi3a::CopyClones(TClonesArray* cl1, TClonesArray* cl2, Int_t offset)
{
    ...
    LOG(INFO) << "R3BFi3a: " << nEntries << " entries to add" << FairLogger::endl;
    ...
    LOG(INFO) << "R3BFi3a: " << cl2->GetEntriesFast() << " merged entries" << FairLogger::endl;
}
