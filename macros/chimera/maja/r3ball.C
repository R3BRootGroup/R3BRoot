...
// Output files
  ...
  R3BPrimaryGenerator* primGen = new R3BPrimaryGenerator();
 ...
 //-----------------------------------------
 if (fGenerator.CompareTo("iqmd") == 0  ) {
   R3BAsciiIQMDGen* asciiGeniqmd=new R3BAsciiIQMDGen("/u/mzoric/chimera/r3broot/input/chimera/infile.in");
   primGen->AddGenerator(asciiGeniqmd);
 }
  if (fGenerator.CompareTo("urqmd") == 0  ) {
   R3BAsciiUrQMDGen* asciiGenurqmd=new R3BAsciiUrQMDGen("/u/mzoric/chimera/r3broot/input/chimera/infile2.in");
   primGen->AddGenerator(asciiGenurqmd);
 }
//------------------------------------------
...
//   db->ReadPDGTable("/u/mzoric/chimera/r3broot/input/chimera/new_ionlist.in");
  ...
  cout << "Real time " << rtime << " s, CPU time " << ctime 
       << "s" << endl << endl;
  primGen->WriteTable("/u/mzoric/chimera/r3broot/eventdisplay/new_ionlist.in");
  // ------------------------------------------------------------------------
