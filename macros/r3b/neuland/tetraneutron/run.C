...
void Reconstruct(const RunConfig& cfg)
{
    ...
    run->AddTask(new R3BNeulandNeutronReconstruction(
        new Neuland::Reconstruction2DCalibr(cfg.energy-30., cfg.energy+30., 0.), "NeulandClusters", "NeulandNeutrons2DCalibr"));
    run->AddTask(new R3BNeulandNeutronReconstruction(
        new Neuland::ReconstructionEGate(cfg.energy-30., cfg.energy+30., 0.), "NeulandClusters", "NeulandNeutronsEGate"));
/*    run->AddTask(new R3BNeulandNeutronReconstruction(
