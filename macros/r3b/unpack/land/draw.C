...
void plot_s438_tdiff()
{
    TPstyle();
    
    TFile* file = new TFile("/Volumes/Data/kresan/s438/cosmic/run107_cosmic.root");
    
    TH1F* h_tdiff_1 = (TH1F*) file->Get("h_tdiff_1");
    ...
    TCanvas* c1 = new TCanvas("c1", "", 10, 10, 1000, 500);
    c1->Divide(2, 1);
    TPostScript* ps1 = new TPostScript("plots/s438_run107_compare_tdiff.eps", -113);
    ps1->Range(32, 16);
    c1->cd(1);
    gPad->SetLeftMargin(0.15);
    gPad->SetRightMargin(0.05);
...
void plot_s438_cosmic()
{
    TPstyle();
    
    TFile *file = new TFile("/Volumes/Data/kresan/s438/digi/run107_digi.root");
    ...
    TCanvas* c1 = new TCanvas("c1", "", 10, 10, 1000, 500);
    c1->Divide(2, 1);
    TPostScript* ps1 = new TPostScript("plots/s438_run107_yx.eps", -113);
    ps1->Range(32, 16);
    c1->cd(1);
    gPad->SetLeftMargin(0.15);
    gPad->SetRightMargin(0.12);
    ...
    TPostScript* ps2 = new TPostScript("plots/s438_run107_qdcbar.eps", -113);
    ps2->Range(16, 16);
    gPad->SetLeftMargin(0.17);
    gPad->SetRightMargin(0.12);
    gPad->SetLogz();
