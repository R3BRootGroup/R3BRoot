...
#include "/home/bloeher/git/R3BRoot/r3bsource/ext_h101_raw_nnp.h"
}
...
void unpack_ucesb_tacquila_bl()
{
    ...
    TString filename = "/data/r3b/r3broot_dev/lmd/run269_2875.lmd.gz";
    TString outputFileName = "/data/r3b/r3broot_dev/root/run269_2875.root";
	...
	(EXT_STR_h101_unpack*)&ucesb_struct.unpack,
	offsetof(EXT_STR_h101, unpack)));
    /*source->AddReader(new R3BNeulandTamexReader(&ucesb_struct));*/
    source->AddReader(new R3BNeulandTacquilaReader(
	(EXT_STR_h101_raw_nnp*)&ucesb_struct.nnp,
	offsetof(EXT_STR_h101, nnp)));
    /* ------------------------------------------------------ */
