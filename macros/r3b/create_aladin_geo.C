...
void create_aladin_geo(const char* geoTag)
{
  ...
  cell->AddNode(pVolFeYoke_down, 1, t2);
  cell->AddNode(pVolFeYoke_left, 1, t3);
  cell->AddNode(pVolFeYoke_right,1, t4);
  ...
  cell->AddNode(pHeliumAladinChamberLog1,1,pMatrix61);
  cell->AddNode(pHeliumAladinChamberLog2,1,pMatrix62);
  cell->AddNode(pHeliumAladinChamberLog3,1,pMatrix63);
