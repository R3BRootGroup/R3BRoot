...
void califaAna_Protons_100MeV(Int_t nEvents = 10000, 
		TString file_r3bsim    = "r3bsim_Protons_100MeV.root",
		TString file_r3bpar    = "r3bpar_Protons_100MeV.root",
		TString file_califaAna = "califaAna_Protons_100MeV.root"
		) {
