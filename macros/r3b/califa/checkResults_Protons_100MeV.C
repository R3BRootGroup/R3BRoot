...
void checkResults_Protons_100MeV() {
	char title0[250];
	char title1[250];
...
using std::ios;
	...
	Double_t maxE =  Eproj*5;


	//TString title0 = "califaAna.root";
	//TString title1 =    "r3bsim.root";
	sprintf(title0,"%s","/home/josesrs/r3broot_sept2012/macros/r3b/califa/califaAna_Protons_100MeV.root");  
 	sprintf(title1,"%s","/home/josesrs/r3broot_sept2012/macros/r3b/califa/r3bsim_Protons_100MeV.root");  	
...
//BARREL
	...
	for(Int_t i=0;i<nevents;i++){
        ...
        TFile f_100MeV("/home/josesrs/r3broot_sept2012/macros/r3b/califa/hist_Endcap21_100MeV.root", "recreate");
	f_100MeV->cd();
