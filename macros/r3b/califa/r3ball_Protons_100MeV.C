...
//        1) root -l
//        2)[root] .L r3ball_Protons_50MeV.C 
//                         
//        3)[root] r3ball_Protons_50MeV( nevt,
...
void r3ball_Protons_100MeV( Int_t nEvents = 10000,
	    TObjArray& fDetList,
	    TString Target = "LeadTarget",
		Bool_t fVis=kFALSE,
		TString fMC="TGeant4",
	    TString fGenerator=/*"ascii"*/"box",
	    Bool_t fUserPList= kFALSE,
		Bool_t fR3BMagnet= kTRUE , 
		Double_t momentum=0.4442972, 
		TString OutFile = "r3bsim_Protons_100MeV.root", 
		TString ParFile = "r3bpar_Protons_100MeV.root" 
		)
{
...
if (fGenerator.CompareTo("ascii") == 0  ) {
    FairAsciiGenerator* asciiGen = new FairAsciiGenerator(/*"/home/josesrs/Reactions_p_2p_R3BRoot/genGRp2p.out"*/"/home/josesrs/Reactions_p_2p_R3BRoot/ResultsR3BRoot/EndcapPhoswich_4_2/Reaction57Ni+p->p+p+56Co/genGRp2p.out");
  ...
  if (fGenerator.CompareTo("gammas") == 0  ) {
	...
	//gammasGen->SetLorentzBoost(0.85); //beta=0.81975 for 700 A MeV  LO PONGO YO
