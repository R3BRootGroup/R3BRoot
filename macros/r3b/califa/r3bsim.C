...
void r3bsim()
{
    ...
    //  detGeo.Add(new TObjString("VACVESSELCOOL"), new TObjString("vacvessel_v14a.geo.root"));   // to be used only
    //  with the R3B tracker: "STaRTrack", not "TRACKER" detGeo.Add(new TObjString("VACVESSELCOOL"), new
    //  TObjString("vacvessel_v13a.geo.root")); detGeo.Add(new TObjString("MFI"),           new
    //  TObjString("mfi_v13a.geo.root"));
    ...
    r3ball(nEvents, &detGeo, target4, fEventDisplay, fMC, fGene, fUserPList, fR3BMagnet, 1500., OutFile, ParFile);
}
