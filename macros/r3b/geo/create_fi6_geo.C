void create_fi6_geo(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/geometry/fi6_";
  ...
  Float_t detector_width = 50.000000;
  ...
  TGeoVolume* pGFILog = new TGeoVolume("FI6Log",pGFITube, pMed35);

   TGeoShape *pGFITubeActive = new TGeoTube("GFITubeActive", 0, (fiber_thickness * .97)/2, detector_height-0.0001);

  TGeoVolume* pGFILogActive = new TGeoVolume("FI61Log",pGFITubeActive,pMed35);
