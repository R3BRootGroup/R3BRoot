...
void plot_minv_tn()
{
  ...
  TFile *file_4n = new TFile("/home/kresan/neuland/r3breco.600AMeV.4n.100keV.35m.root");
...
void plot_minv_astro()
{
  ...
  TFile *file_1n = new TFile("/home/kresan/neuland/r3breco.600AMeV.1n.100keV.35m.root");
