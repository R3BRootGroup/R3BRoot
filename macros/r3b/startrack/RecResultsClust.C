...
void RecResultsClust(char* output) {
  ...
  gStyle->SetOptFit(0);
	...
	*/
	...
	Int_t *DetCopyIDClust;  // Detector Copy ID in Cluster

	Int_t *Stripfrt;  // front strip ID
	Int_t *Stripbck;  // back Strip ID
	Int_t *StripfrtClust;  // main front Strip ID in cluster
	Int_t *StripbckClust;  // main back Strip ID in cluster
 
	Int_t StripfrtClustID, StripbckClustID;
   ...
   // Middle layer:
	...
	for(Int_t i=0;i<nevents;i++){
	    ...
	    */
	    ...
	    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	    //
	    // 1st loop over Tracker  Multiplicity (reading the tree)
	    //
	    ...
	    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
	    //
	    //  2nd loop over tracker multiplicity to
