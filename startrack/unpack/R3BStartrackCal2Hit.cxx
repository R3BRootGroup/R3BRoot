...
InitStatus R3BStartrackCal2Hit::ReInit() { return kSUCCESS; }
...
//      R3BStartrackerDigitHit* R3BStartrackCal2Hit::AddHit(Double_t ene,Int_t det,Int_t Stripfrt, Int_t Stripbck,
//      Double_t time){

//  Use R3BStartrackerDigitHit to produce a root tree with raw data:
R3BStartrackerDigitHit* R3BStartrackCal2Hit::AddHit(Int_t det,
                                                    Int_t chip,
                                                    Int_t side,
                                                    Int_t strip,
                                                    Double_t ene,
                                                    Double_t time)
{
    ...
    // R3BStartrackerHitData* R3BStartrackCal2Hit::AddHit(Int_t Track, Double_t ene, Double pAngle, Double aAngle,
    // Double_t time){   // TODO !!
