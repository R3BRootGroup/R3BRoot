...
class R3BStartrackMapped2Cal : public FairTask
{
  public:
    ...
    //virtual void InsertionSort2(vector<long long> & v_ts, vector<long long> & v_block_index, vector<long long> & v_hit_index);
  ...
  private:
    ...
    //
    TClonesArray* fMappedItemsCA;                 /**< Array with mapped items - input data. as defined in r3bdata/StartrackData/R3BStartrackMappedData  */
    TClonesArray* fCalItemsCA;                    /**< Array with cal items - output data.  as defined in r3bdata/StartrackData/R3BStartrackCalData */
