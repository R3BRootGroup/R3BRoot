...
R3BStartrackDigit::R3BStartrackDigit() : FairTask("R3B STaRTracker Hit Raw Sim data ") { 
...
InitStatus R3BStartrackDigit::ReInit() {
...
//      R3BStartrackerDigitHit* R3BStartrackDigit::AddHit(Double_t ene,Int_t det,Int_t Stripfrt, Int_t Stripbck, Double_t time){   
        R3BStartrackerDigitHit* R3BStartrackDigit::AddHit(Int_t det,Int_t chip, Int_t side, Int_t strip, Double_t ene, Double_t time){   
