...
// -------------------------------------------------------------------------
#include "R3BStartrackHitFinder.h"
#include "TMath.h"
#include "TVector3.h"
...
R3BStartrackHitFinder::R3BStartrackHitFinder() : FairTask("R3B STaRTracker Hit Finder ") { 
	fThreshold=0.;	   //no threshold
	fTrackerResolution=0.; //perfect resolution
}


R3BStartrackHitFinder::~R3BStartrackHitFinder() {
}


// -----   Public method Init   --------------------------------------------
InitStatus R3BStartrackHitFinder::Init() {
	...
	// Register output array StartrackHit
	fStartrackHitCA = new TClonesArray("R3BStartrackHit",1000);
	ioManager->Register("StartrackHit", "STaRTracker Hit", fStartrackHitCA, kTRUE);	
...
InitStatus R3BStartrackHitFinder::ReInit() {
...
// -----   Public method Exec   --------------------------------------------
void R3BStartrackHitFinder::Exec(Option_t* opt) {
...
// ---- Public method Reset   --------------------------------------------------
void R3BStartrackHitFinder::Reset(){
	// Clear the CA structure
	// cout << " -I- R3BStartrackHitFinder:Reset() called " << endl;
...
void R3BStartrackHitFinder::Finish()
{
...
// -----  Public method SetExperimentalResolution  ----------------------------------
 void R3BStartrackHitFinder::SetExperimentalResolution(Double_t trackerRes)
{	
	fTrackerResolution=trackerRes;
    cout << "-I- R3BStartrackHitFinder::SetExperimentalResolution to " << fTrackerResolution << " GeV" << endl;
}


// -----  Public method SetDetectionThreshold  ----------------------------------
void R3BStartrackHitFinder::SetDetectionThreshold(Double_t thresholdEne)
{	
	fThreshold=thresholdEne;
	cout << "-I- R3BStartrackHitFinder::SetDetectionThreshold to " << fThreshold << " GeV" << endl;
}


// -----   Private method ExpResSmearing  --------------------------------------------
Double_t R3BStartrackHitFinder::ExpResSmearing(Double_t inputEnergy) {
...
Double_t R3BStartrackHitFinder::GetThetaScatZero(Double_t X, Double_t Y, Double_t Z){
...
Double_t R3BStartrackHitFinder::GetPhiScatZero(Double_t X, Double_t Y, Double_t Z){
...
// -----   Private method AddHit  --------------------------------------------
	R3BStartrackerHit* R3BStartrackHitFinder::AddHit(Double_t ene,Int_t det,Double_t x,Double_t y,Double_t z, Double_t px, Double_t py, Double_t pz, Double_t th,Double_t phi){   
...
ClassImp(R3BStartrackHitFinder)
