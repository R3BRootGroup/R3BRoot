...
void R3BSTaRTra::ConstructGeometry()
{
    ...
    else
    {
        ...
        TGeoMixture* pVacMat = new TGeoMixture("Vacuum", nel, density);
        a = 14.006740;
        z = 7.000000;
        w = 0.700000; // N
    ...
    /*
     TGeoShape *pSTaRTrackWorld =new TGeoTubeSeg("STarTrack_Tube",
                            4.,   // rmin // put it to 4 for delat e- and protons; TODO: modify geo to leave it to 0 all
     the time
                            //26.2,   // rmin // put it to 26.2 for gamma attenuation study; TODO: modify geo to leave
     it to 0 or 4 all the time 26.4, // rmax (cf: Chamber in passive/R3BvacVesselcool.cxx 35.,  // dz 0.,   // phi1
                            360.);// phi2
   ...
   */
    ...
    */
    ...
    pAWorld->AddNode(
        aTra, 0, t1); // when use the world as mother volume of the tracker -> impli vacuum is made in all cave
}
