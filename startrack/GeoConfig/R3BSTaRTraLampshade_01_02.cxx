...
// Material: Aluminum
   ...
   dz = Length1*cos(InclAng1*PI/180.)/2 - (Length1*cos(InclAng1*PI/180.) - (Rmin1/tan(AngRangeMin1*PI/180.)));
   // Rotation: 
   ...
   //thy = 0.;   
   //thz = 0;    
   //TGeoRotation *pMatrix3 = new TGeoRotation("",thz,thx,thy); // Euler phi (rot/z), theta (rot/x), psi (rot/y) angles
   TGeoCombiTrans*
   ...
   //thy = 0.;   
   //thz = -39.;    
   //TGeoRotation *pMatrix5 = new TGeoRotation("",thz,thx,thy); // Euler phi (rot/z), theta (rot/x), psi (rot/y) angles
   TGeoCombiTrans*
   ...
   dz = Length2*cos(InclAng2*PI/180.)/2 - (Length2*cos(InclAng2*PI/180.) - (Rmin2/tan(AngRangeMin2*PI/180.)));
   // Rotation: 
   thx = 90.000000;        phx = 0.000000;
  ...
  // Third layer
   ...
   dz = Length3*cos(InclAng3*PI/180.)/2 - (Length3*cos(InclAng3*PI/180.) - (Rmin3/tan(AngRangeMin3*PI/180.)));
   // Rotation: 
   thx = 90.000000;        phx = 0.000000;
   ...
   */
   ...
   TGeoVolume* STaRTraLog6 = new TGeoVolume("STaRTraLog6",Tra6, pMed22);
	...
	// Volume: ChamberLog
	TGeoVolume*
	pChamberBarrelLog = new TGeoVolume("ChamberBarrelLog",pChamberBarrel, pMed3);
	...
	// Volume: pGoldCone
	TGeoVolume*
	pChamberEnd1Log = new TGeoVolume("ChamberEnd1Log",pChamberEnd1, pMed3);
   ...
   aTra->AddNode(STaRTraLog2,7, pMatrix66); 
   aTra->AddNode(STaRTraLog2,8, pMatrix68);
   aTra->AddNode(STaRTraLog2,9, pMatrix70); 
   aTra->AddNode(STaRTraLog2,10, pMatrix72);
   aTra->AddNode(STaRTraLog2,11, pMatrix74); 
   aTra->AddNode(STaRTraLog2,12, pMatrix76);
   aTra->AddNode(STaRTraLog2,13, pMatrix78); 
   aTra->AddNode(STaRTraLog2,14, pMatrix80);
   aTra->AddNode(STaRTraLog2,15, pMatrix82); 
   aTra->AddNode(STaRTraLog2,16, pMatrix84);
   aTra->AddNode(STaRTraLog2,17, pMatrix86); 
   aTra->AddNode(STaRTraLog2,18, pMatrix88);

  // Third layer 

   aTra->AddNode(STaRTraLog3,19, pMatrix34); 
   aTra->AddNode(STaRTraLog3,20, pMatrix36);
   aTra->AddNode(STaRTraLog3,21, pMatrix38); 
   aTra->AddNode(STaRTraLog3,22, pMatrix40);
   aTra->AddNode(STaRTraLog3,23, pMatrix42); 
   aTra->AddNode(STaRTraLog3,24, pMatrix44);
   aTra->AddNode(STaRTraLog3,25, pMatrix46); 
   aTra->AddNode(STaRTraLog3,26, pMatrix48);
   aTra->AddNode(STaRTraLog3,27, pMatrix50); 
   aTra->AddNode(STaRTraLog3,28, pMatrix52);
   aTra->AddNode(STaRTraLog3,29, pMatrix54); 
   aTra->AddNode(STaRTraLog3,30, pMatrix56);
   ...
   //aTra->AddNode(STaRTraLog1,2, GetGlobalPosition(t0));
   //aTra->AddNode(STaRTraLog3,2, GetGlobalPosition(t0));
