...
void R3BTCalContFact::setAllContainers()
{
    ...
    FairContainer* p4 = new FairContainer("PtofTCalPar", "PTOF TCAL Calibration Parameters", "TestDefaultContext");
    p4->addContext("TestNonDefaultContext");
    containers->Add(p4);

    FairContainer* p5 = new FairContainer("StrawtubesTCalPar", "Strawtubes TCAL Calibration Parameters", "TestDefaultContext");
