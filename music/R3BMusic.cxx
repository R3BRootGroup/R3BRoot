...
void R3BMusic::Register() {
  FairRootManager::Instance()->Register("MusicPoint", GetName(),
					fMusicCollection, kTRUE);
}
...
R3BMusicPoint* R3BMusic::AddPoint(Int_t trackID,
  ...
  return new (clref[size]) R3BMusicPoint(trackID, detID, volid, Z, A, posIn, posOut, momIn, momOut, time, length, eLoss);
}
