...
class R3BATof : public R3BDetector
{
 ...
 public:
   ...
   **/
  R3BATof(const char* name, Bool_t active);
   ...
   ** active volume. Creates a R3BATofPoint and adds it to the
   ** collection.
...
//  void SaveGeoParams();
  ...
  private:
     ...
     **/
    R3BATofPoint* AddHit(Int_t trackID, Int_t detID, Int_t mod, TVector3 posIn,
...
inline void R3BATof::ResetParameters() {
