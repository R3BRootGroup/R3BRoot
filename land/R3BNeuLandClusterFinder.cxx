  ...
  if (nDigis > 0 && nDigis <= 3000) {
	...
	if(TMath::Abs(delx) < 7.5 && TMath::Abs(dely) < 7.5 &&
	  ...
	  if(belongsToCluster[i] > -1) {
	    ...
	    // Create new cluster
	    new ((*fArrayCluster)[nClusters]) R3BNeuLandCluster(digi2->GetXX(), digi2->GetYY(), digi2->GetZZ(),
							 digi2->GetTdc(),
							 digi2->GetXX(), digi2->GetYY(), digi2->GetZZ(),
							 digi2->GetTdc(),
							 digi2->GetQdc(), 1);
...
void R3BNeuLandClusterFinder::CreateHistograms()
{
  ...
  fhClusterNo_vs_Size = new TH2F("hClusterNo_vs_Size", "Number of Clusters vs. Total Size",
