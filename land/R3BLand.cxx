...
R3BLandPoint* R3BLand::AddHit(Int_t trackID, Int_t detID, TVector3 posIn,
  ...
  return new(clref[size]) R3BLandPoint(trackID, detID, posIn, posOut,
...
//
  ...
  TGeoVolume *padle_h_box5
      =gGeoManager->MakeBox("padle_h_box5",Iron,
                                    padle_h_dim5x,
				    padle_h_dim5y,
				    padle_h_dim5z);
