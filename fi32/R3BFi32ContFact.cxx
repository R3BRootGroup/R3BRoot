...
ClassImp(R3BFi32ContFact)

    static R3BFi32ContFact gR3BFi32ContFact;

R3BFi32ContFact::R3BFi32ContFact()
{
    // Constructor (called when the library is loaded)
    fName = "R3BFi32ContFact";
    fTitle = "Factory for parameter containers in libR3BFi32";
    setAllContainers();
    FairRuntimeDb::instance()->addContFactory(this);
}

void R3BFi32ContFact::setAllContainers()
{
    ...
    FairContainer* p2 = new FairContainer("fi32GeoPar", "Fi32 geometry parameters", "TestDefaultContext");
    p2->addContext("TestNonDefaultContext");
    containers->Add(p2);
}

FairParSet* R3BFi32ContFact::createContainer(FairContainer* c)
{
...
void R3BFi32ContFact::activateParIo(FairParIo* io)
{
