...
R3BFi32DigitizerCal::R3BFi32DigitizerCal()
    : FairTask("R3B Fi32 Digitization scheme ", 1)
    , fFi32Points(NULL)
{
}

R3BFi32DigitizerCal::R3BFi32DigitizerCal(const char* name, Int_t iVerbose)
...
InitStatus R3BFi32DigitizerCal::Init()
{
    ...
    fFi32Cals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi32Cal", "Digital response in Fi32", fFi32Cals, kTRUE);

    fFi32TriggerCals = new TClonesArray("R3BBunchedFiberCalData", 1000);
    ioman->Register("Fi32TriggerCal", "Digital response in Fi32", fFi32TriggerCals, kTRUE);
...
void R3BFi32DigitizerCal::Exec(Option_t* opt)
{
    Reset();
    ...
    if (fFi32Points)
    {
        Digitize(fFi32Points, fFi32Cals, fFi32TriggerCals, fiber_nbr);
    }
}
// -------------------------------------------------------------------------

void R3BFi32DigitizerCal::Reset()
{
    if (fFi32Cals)
        fFi32Cals->Clear();
    if (fFi32TriggerCals)
        fFi32TriggerCals->Clear();
}

void R3BFi32DigitizerCal::Finish() {}

ClassImp(R3BFi32DigitizerCal)
